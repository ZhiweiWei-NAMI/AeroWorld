    ...
    namespace msr
{
    namespace airlib
    {
        ...
        std::string RpcLibClientBase::simAeroDescribeCapabilities(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroDescribeCapabilities", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroLoadContext(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroLoadContext", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroReloadConfig(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroReloadConfig", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroApplyFrame(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroApplyFrame", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPollFeedback(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPollFeedback", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedSpawn(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedSpawn", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedReset(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedReset", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedSetTarget(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedSetTarget", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedObserve(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedObserve", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedPlayAnimation(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedPlayAnimation", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedCommitCross(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedCommitCross", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedStop(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedStop", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedSetVariant(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedSetVariant", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedRelease(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedRelease", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedSpawnCrowd(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedSpawnCrowd", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedClearCrowd(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedClearCrowd", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroPedRespawnCrowd(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroPedRespawnCrowd", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroSpawnAsset(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroSpawnAsset", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroMoveAsset(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroMoveAsset", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroRemoveAsset(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroRemoveAsset", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroCaptureWorldCamera(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroCaptureWorldCamera", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroReserveOccupancy(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroReserveOccupancy", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroReleaseOccupancy(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroReleaseOccupancy", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroQueryNearest(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroQueryNearest", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroQueryPedPath(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroQueryPedPath", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroProjectGround(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroProjectGround", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroQueryPedAnchor(const std::string& request_json)
        {
            return pimpl_->client.call("simAeroQueryPedAnchor", request_json).as<std::string>();
        }

        std::string RpcLibClientBase::simAeroApplyWeather(const std::string& request_json)
        {
