...
namespace airlib
{
    ...
    public:
        ...
        std::string simAeroDescribeCapabilities(const std::string& request_json = "{}");
        std::string simAeroLoadContext(const std::string& request_json);
        std::string simAeroReloadConfig(const std::string& request_json);
        std::string simAeroApplyFrame(const std::string& request_json);
        std::string simAeroPollFeedback(const std::string& request_json = "{}");
        std::string simAeroPedSpawn(const std::string& request_json);
        std::string simAeroPedReset(const std::string& request_json);
        std::string simAeroPedSetTarget(const std::string& request_json);
        std::string simAeroPedObserve(const std::string& request_json);
        std::string simAeroPedPlayAnimation(const std::string& request_json);
        std::string simAeroPedCommitCross(const std::string& request_json);
        std::string simAeroPedStop(const std::string& request_json);
        std::string simAeroPedSetVariant(const std::string& request_json);
        std::string simAeroPedRelease(const std::string& request_json);
        std::string simAeroPedSpawnCrowd(const std::string& request_json);
        std::string simAeroPedClearCrowd(const std::string& request_json);
        std::string simAeroPedRespawnCrowd(const std::string& request_json);
        std::string simAeroSpawnAsset(const std::string& request_json);
        std::string simAeroMoveAsset(const std::string& request_json);
        std::string simAeroRemoveAsset(const std::string& request_json);
        std::string simAeroCaptureWorldCamera(const std::string& request_json);
        std::string simAeroReserveOccupancy(const std::string& request_json);
        std::string simAeroReleaseOccupancy(const std::string& request_json);
        std::string simAeroQueryNearest(const std::string& request_json);
        std::string simAeroQueryPedPath(const std::string& request_json);
