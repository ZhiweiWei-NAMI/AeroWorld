...
namespace airlib
{
    ...
    public:
        ...
        virtual std::string simAeroDescribeCapabilities(const std::string& request_json) = 0;
        virtual std::string simAeroLoadContext(const std::string& request_json) = 0;
        virtual std::string simAeroReloadConfig(const std::string& request_json) = 0;
        virtual std::string simAeroApplyFrame(const std::string& request_json) = 0;
        virtual std::string simAeroPollFeedback(const std::string& request_json) = 0;
        virtual std::string simAeroPedSpawn(const std::string& request_json) = 0;
        virtual std::string simAeroPedReset(const std::string& request_json) = 0;
        virtual std::string simAeroPedSetTarget(const std::string& request_json) = 0;
        virtual std::string simAeroPedObserve(const std::string& request_json) = 0;
        virtual std::string simAeroPedPlayAnimation(const std::string& request_json) = 0;
        virtual std::string simAeroPedCommitCross(const std::string& request_json) = 0;
        virtual std::string simAeroPedStop(const std::string& request_json) = 0;
        virtual std::string simAeroPedSetVariant(const std::string& request_json) = 0;
        virtual std::string simAeroPedRelease(const std::string& request_json) = 0;
        virtual std::string simAeroPedSpawnCrowd(const std::string& request_json) = 0;
        virtual std::string simAeroPedClearCrowd(const std::string& request_json) = 0;
        virtual std::string simAeroPedRespawnCrowd(const std::string& request_json) = 0;
        virtual std::string simAeroSpawnAsset(const std::string& request_json) = 0;
        virtual std::string simAeroMoveAsset(const std::string& request_json) = 0;
        virtual std::string simAeroRemoveAsset(const std::string& request_json) = 0;
        virtual std::string simAeroCaptureWorldCamera(const std::string& request_json) = 0;
        virtual std::string simAeroReserveOccupancy(const std::string& request_json) = 0;
        virtual std::string simAeroReleaseOccupancy(const std::string& request_json) = 0;
        virtual std::string simAeroQueryNearest(const std::string& request_json) = 0;
        virtual std::string simAeroQueryPedPath(const std::string& request_json) = 0;
