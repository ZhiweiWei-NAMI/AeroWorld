...
public:
    ...
    virtual std::string simAeroDescribeCapabilities(const std::string& request_json) override;
    virtual std::string simAeroLoadContext(const std::string& request_json) override;
    virtual std::string simAeroReloadConfig(const std::string& request_json) override;
    virtual std::string simAeroApplyFrame(const std::string& request_json) override;
    virtual std::string simAeroPollFeedback(const std::string& request_json) override;
    virtual std::string simAeroPedSpawn(const std::string& request_json) override;
    virtual std::string simAeroPedReset(const std::string& request_json) override;
    virtual std::string simAeroPedSetTarget(const std::string& request_json) override;
    virtual std::string simAeroPedObserve(const std::string& request_json) override;
    virtual std::string simAeroPedPlayAnimation(const std::string& request_json) override;
    virtual std::string simAeroPedCommitCross(const std::string& request_json) override;
    virtual std::string simAeroPedStop(const std::string& request_json) override;
    virtual std::string simAeroPedSetVariant(const std::string& request_json) override;
    virtual std::string simAeroPedRelease(const std::string& request_json) override;
    virtual std::string simAeroPedSpawnCrowd(const std::string& request_json) override;
    virtual std::string simAeroPedClearCrowd(const std::string& request_json) override;
    virtual std::string simAeroPedRespawnCrowd(const std::string& request_json) override;
    virtual std::string simAeroSpawnAsset(const std::string& request_json) override;
    virtual std::string simAeroMoveAsset(const std::string& request_json) override;
    virtual std::string simAeroRemoveAsset(const std::string& request_json) override;
    virtual std::string simAeroCaptureWorldCamera(const std::string& request_json) override;
    virtual std::string simAeroReserveOccupancy(const std::string& request_json) override;
    virtual std::string simAeroReleaseOccupancy(const std::string& request_json) override;
    virtual std::string simAeroQueryNearest(const std::string& request_json) override;
    virtual std::string simAeroQueryPedPath(const std::string& request_json) override;
...
private:
    ...
    std::string invokeAeroBridge(const char* operation_name, const char* function_name, const std::string& request_json);
    void spawnPlayer();
