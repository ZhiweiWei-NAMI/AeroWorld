...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [92.667, 16.333, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [78.0, 27.0, 32], 'rotation_deg': {'yaw_deg': 75}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[92.0, 17.0, 5]]},
              {'activation_tick': 0,
               'category': 'uav',
               'entity_id': 'uav_divert_l2_4_v1',
               'initial_state': {'mode': 'landing_request'},
               'logical_asset_id': 'uav.airsim.flying_pawn.v1',
               'placement': {'position_enu_m': [108.0, 5.0, 30], 'rotation_deg': {'yaw_deg': 295}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[104.0, 29.0, 36]]}],
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_priority_uav_to_pad',
                 ...
                 {'actions': [{'params': {'action_id': 'move_second_uav_diversion',
                                          'entity_id': 'uav_divert_l2_4_v1',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[104.0, 29.0, 36], [124.0, 37.0, 34]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_priority_uav_landing',
                                          'entity_id': 'uav_priority_l2_4_v1',
                                          'velocity_mps': 1.5,
                                          'waypoints_enu_m': [[92.0, 17.0, 5], [92.0, 17.0, 1.2]]},
                               'type': 'move_entity'}],
