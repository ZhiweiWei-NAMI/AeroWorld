...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7092.667, 6216.333, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7078.0, 6227.0, 32],
                             'resolved_position_enu_m': [7078.0, 6227.0, 32],
                             'rotation_deg': {'yaw_deg': 75}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7092.0, 6217.0, 5]]},
              {'activation_tick': 0,
               'category': 'uav',
               'entity_id': 'uav_divert_l2_4_v1',
               'initial_state': {'mode': 'landing_request'},
               'logical_asset_id': 'uav.airsim.flying_pawn.v1',
               'placement': {'position_enu_m': [7108.0, 6205.0, 30],
                             'resolved_position_enu_m': [7108.0, 6205.0, 30],
                             'rotation_deg': {'yaw_deg': 295}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7104.0, 6229.0, 36]]}],
 'local_bounds': {'center_enu_m': [7094.8, 6219.0, 0.0], 'radius_m': 179.242, 'source': 'scene_entities_and_routes'},
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.landing_pad.visible.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_priority_l2_4_v1',
               'initial_pos_enu': [7078.0, 6227.0, 32],
               'initial_rotation_deg': [0.0, 0.0, 75],
               'movement_waypoints': [[7092.0, 6217.0, 5]],
               'visual_state': {'mode': 'emergency_landing'}},
              {'asset_id': 'uav.airsim.flying_pawn.v1',
               'entity_id': 'uav_divert_l2_4_v1',
               'initial_pos_enu': [7108.0, 6205.0, 30],
               'initial_rotation_deg': [0.0, 0.0, 295],
               'movement_waypoints': [[7104.0, 6229.0, 36]],
