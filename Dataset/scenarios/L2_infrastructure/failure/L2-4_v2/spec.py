...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7099.667, 6221.833, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7085.0, 6232.5, 32],
                             'resolved_position_enu_m': [7085.0, 6232.5, 32],
                             'rotation_deg': {'yaw_deg': 75}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7099.0, 6222.5, 5]]},
              {'activation_tick': 0,
               'category': 'uav',
               'entity_id': 'uav_divert_l2_4_v2',
               'initial_state': {'mode': 'landing_request'},
               'logical_asset_id': 'uav.airsim.flying_pawn.v1',
               'placement': {'position_enu_m': [7115.0, 6210.5, 30],
                             'resolved_position_enu_m': [7115.0, 6210.5, 30],
                             'rotation_deg': {'yaw_deg': 295}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7111.0, 6234.5, 36]]}],
 'local_bounds': {'center_enu_m': [7101.8, 6224.5, 0.0], 'radius_m': 179.242, 'source': 'scene_entities_and_routes'},
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_priority_uav_to_pad',
                              ...
                              {'params': {'action_id': 'move_second_uav_to_pad_hold',
                                          'entity_id': 'uav_divert_l2_4_v2',
                                          'velocity_mps': 5.5,
                                          'waypoints_enu_m': [[7115.0, 6210.5, 30],
                                                              [7103.0, 6218.5, 24],
                                                              [7111.0, 6234.5, 36]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_second_uav_diversion',
                                          'entity_id': 'uav_divert_l2_4_v2',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[7111.0, 6234.5, 36], [7131.0, 6242.5, 34]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_priority_uav_landing',
                                          'entity_id': 'uav_priority_l2_4_v2',
                                          'velocity_mps': 1.5,
                                          'waypoints_enu_m': [[7099.0, 6222.5, 5], [7099.0, 6222.5, 1.2]]},
                               'type': 'move_entity'}],
