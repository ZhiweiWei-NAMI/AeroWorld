...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7101.034, 6222.014, 97.634],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7084.304, 6231.594, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_priority_l2_4_v2',
                             'mission_start_enu_m': [7085.0, 6232.5, 32],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7084.304, 6231.594, 3.0],
                             'resolved_position_enu_m': [7084.304, 6231.594, 3.0],
                             'rotation_deg': {'yaw_deg': 75}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7085.0, 6232.5, 32], [7099.0, 6222.5, 5]]},
              {'activation_tick': 0,
               'category': 'uav',
               'entity_id': 'uav_divert_l2_4_v2',
               'initial_state': {'mode': 'preflight_on_pad'},
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7100.957, 6202.501, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_divert_l2_4_v2',
                             'mission_start_enu_m': [7115.0, 6210.5, 30],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.airsim.flying_pawn.v1',
               'placement': {'position_enu_m': [7100.957, 6202.501, 3.0],
                             'resolved_position_enu_m': [7100.957, 6202.501, 3.0],
                             'rotation_deg': {'yaw_deg': 295}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7115.0, 6210.5, 30], [7111.0, 6234.5, 36]]},
              {'activation_tick': 0,
               'category': 'facility',
              ...
              {'activation_tick': 0,
               ...
               'placement_mode': 'pad_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7101.034, 6222.014, 0.0],
                  'radius_m': 196.299,
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.landing_pad.visible.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_priority_l2_4_v2',
               'initial_pos_enu': [7084.304, 6231.594, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 75],
               'movement_waypoints': [[7085.0, 6232.5, 32], [7099.0, 6222.5, 5]],
               'visual_state': {'mode': 'preflight_on_pad'}},
              {'asset_id': 'uav.airsim.flying_pawn.v1',
               'entity_id': 'uav_divert_l2_4_v2',
               'initial_pos_enu': [7100.957, 6202.501, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 295],
               'movement_waypoints': [[7115.0, 6210.5, 30], [7111.0, 6234.5, 36]],
               'visual_state': {'mode': 'preflight_on_pad'}},
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_priority_l2_4_v2_takeoff_entry',
                                          'entity_id': 'uav_priority_l2_4_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7084.304, 6231.594, 3.0],
                                                              [7084.304, 6231.594, 24.0],
                                                              [7085.0, 6232.5, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_divert_l2_4_v2_takeoff_entry',
                                          'entity_id': 'uav_divert_l2_4_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7100.957, 6202.501, 3.0],
                                                              [7100.957, 6202.501, 24.0],
                                                              [7115.0, 6210.5, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_divert_l2_4_v2_landing_return',
                                          'entity_id': 'uav_divert_l2_4_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7131.0, 6242.5, 34.0],
                                                              [7100.957, 6202.501, 22.0],
