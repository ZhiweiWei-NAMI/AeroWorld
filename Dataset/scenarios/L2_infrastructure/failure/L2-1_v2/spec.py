...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7058.0, 6189.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7055.0, 6187.5, 31],
                             'resolved_position_enu_m': [7055.0, 6187.5, 31],
                             'rotation_deg': {'yaw_deg': 30}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7065.0, 6197.5, 30], [7044.0, 6189.5, 31]]}],
 'local_bounds': {'center_enu_m': [7056.25, 6191.5, 0.0], 'radius_m': 172.412, 'source': 'scene_entities_and_routes'},
 'map_ref': {'coordinate_frame': 'ENU',
             'geo_reference': {'alt': 24.0, 'lat': 30.5609, 'lon': 114.3627},
             'map_id': 'donghu_road_topo'},
 'scenario_id': 'L2-1_v2',
 'spawn_sequencing': [{'entity_id': 'tower_l2_1_v2', 'tick': 0}, {'entity_id': 'uav_l2_1_v2', 'tick': 0}],
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l2_1_v2',
               'initial_pos_enu': [7055.0, 6187.5, 31],
               'initial_rotation_deg': [0.0, 0.0, 30],
               'movement_waypoints': [[7065.0, 6197.5, 30], [7044.0, 6189.5, 31]],
