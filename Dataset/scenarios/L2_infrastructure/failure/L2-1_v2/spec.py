...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [58.0, -10.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [61.0, -8.5, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [55.0, -12.5, 31], 'rotation_deg': {'yaw_deg': 30}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[65.0, -2.5, 30], [44.0, -10.5, 31]]}],
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_tower_degraded',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_backup_loiter',
                                          'entity_id': 'uav_l2_1_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[55.0, -12.5, 31], [65.0, -2.5, 30], [68.0, 2.5, 34]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'station_degraded', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_tower_backup',
                              ...
                              {'params': {'action_id': 'move_uav_resume_patrol',
                                          'entity_id': 'uav_l2_1_v2',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[68.0, 2.5, 34], [44.0, -10.5, 31]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'uav_link_response', 'type': 'event_fired'}}],
