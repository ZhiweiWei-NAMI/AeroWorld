...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7054.64, 6190.513, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7050.814, 6186.037, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l2_1_v2',
                             'mission_start_enu_m': [7055.0, 6187.5, 31],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7050.814, 6186.037, 3.0],
                             'resolved_position_enu_m': [7050.814, 6186.037, 3.0],
                             'rotation_deg': {'yaw_deg': 30}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7055.0, 6187.5, 31], [7065.0, 6197.5, 30], [7044.0, 6189.5, 31]]},
              {'activation_tick': 0,
               'category': 'facility',
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7054.64, 6190.513, 0.0],
                  'radius_m': 177.949,
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l2_1_v2',
               'initial_pos_enu': [7050.814, 6186.037, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 30],
               'movement_waypoints': [[7055.0, 6187.5, 31], [7065.0, 6197.5, 30], [7044.0, 6189.5, 31]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l2_1_v2_takeoff_entry',
                                          'entity_id': 'uav_l2_1_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7050.814, 6186.037, 3.0],
                                                              [7050.814, 6186.037, 24.0],
                                                              [7055.0, 6187.5, 31]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_backup_loiter',
                                          'entity_id': 'uav_l2_1_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7055.0, 6187.5, 31],
                                                              [7065.0, 6197.5, 30],
                                                              [7068.0, 6202.5, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'set_tower_backup',
                              ...
                              {'params': {'action_id': 'move_uav_resume_patrol',
                                          'entity_id': 'uav_l2_1_v2',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7068.0, 6202.5, 34], [7044.0, 6189.5, 31]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'delay_ticks': 59, 'event_ref': 'uav_link_response', 'type': 'event_fired_after'}},
                 {'actions': [{'params': {'action_id': 'move_uav_l2_1_v2_landing_return',
                                          'entity_id': 'uav_l2_1_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7044.0, 6189.5, 31.0],
                                                              [7050.814, 6186.037, 22.0],
                                                              [7050.814, 6186.037, 3.0]]},
                               'type': 'move_entity'}],
