"""
Auto-generated P0 scenario spec for: L2-1_v2
Event type: L2-1 — Communication Station Failure
Category: failure
CAAC ref: Non-emergency (infrastructure failure)
SORA SAIL: III
Severity: major
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L2-1_v2",
        category="failure.l2-1",
        description="Cascading station failure, widespread link loss",
        duration_ticks=900,
    )
