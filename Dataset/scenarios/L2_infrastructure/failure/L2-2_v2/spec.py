...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7080.333, 6204.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7069.0, 6198.5, 30],
                             'resolved_position_enu_m': [7069.0, 6198.5, 30],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7083.0, 6202.5, 28], [7097.0, 6212.5, 24], [7087.0, 6218.5, 30]]}],
 'local_bounds': {'center_enu_m': [7084.667, 6207.833, 0.0],
                  'radius_m': 178.236,
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.airsim.cv_pawn.v1',
               'entity_id': 'uav_l2_2_v2',
               'initial_pos_enu': [7069.0, 6198.5, 30],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7083.0, 6202.5, 28], [7097.0, 6212.5, 24], [7087.0, 6218.5, 30]],
