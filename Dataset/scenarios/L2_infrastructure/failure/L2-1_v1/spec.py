...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [51.0, -16.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [54.0, -14.0, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [48.0, -18.0, 31], 'rotation_deg': {'yaw_deg': 30}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[58.0, -8.0, 30], [37.0, -16.0, 31]]}],
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_tower_degraded',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_backup_loiter',
                                          'entity_id': 'uav_l2_1_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[48.0, -18.0, 31], [58.0, -8.0, 30], [61.0, -3.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'set_tower_backup',
                              ...
                              {'params': {'action_id': 'move_uav_resume_patrol',
                                          'entity_id': 'uav_l2_1_v1',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[61.0, -3.0, 34], [37.0, -16.0, 31]]},
                               'type': 'move_entity'}],
