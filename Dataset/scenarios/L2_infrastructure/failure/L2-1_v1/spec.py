...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7050.486, 6185.965, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7051.876, 6183.233, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l2_1_v1',
                             'mission_start_enu_m': [7048.0, 6182.0, 31],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7051.876, 6183.233, 3.0],
                             'resolved_position_enu_m': [7051.876, 6183.233, 3.0],
                             'rotation_deg': {'yaw_deg': 30}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7048.0, 6182.0, 31], [7058.0, 6192.0, 30], [7037.0, 6184.0, 31]]},
              {'activation_tick': 0,
               'category': 'facility',
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7050.486, 6185.965, 0.0],
                  'radius_m': 175.242,
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l2_1_v1',
               'initial_pos_enu': [7051.876, 6183.233, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 30],
               'movement_waypoints': [[7048.0, 6182.0, 31], [7058.0, 6192.0, 30], [7037.0, 6184.0, 31]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l2_1_v1_takeoff_entry',
                                          'entity_id': 'uav_l2_1_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7051.876, 6183.233, 3.0],
                                                              [7051.876, 6183.233, 24.0],
                                                              [7048.0, 6182.0, 31]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l2_1_v1_landing_return',
                                          'entity_id': 'uav_l2_1_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7037.0, 6184.0, 31.0],
                                                              [7051.876, 6183.233, 22.0],
                                                              [7051.876, 6183.233, 3.0]]},
                               'type': 'move_entity'}],
