"""
Auto-generated P0 scenario spec for: L2-2_v1
Event type: L2-2 — GNSS Signal Degradation
Category: failure
CAAC ref: CAAC-4 related (obstacle strike due to nav error)
SORA SAIL: III-IV
Severity: minor
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L2-2_v1",
        category="failure.l2-2",
        description="Gradual multipath degradation in urban canyon",
        duration_ticks=900,
    )
