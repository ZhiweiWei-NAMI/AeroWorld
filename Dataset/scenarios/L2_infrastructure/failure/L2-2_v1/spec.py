...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7068.659, 6198.423, 82.158],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7049.752, 6188.841, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l2_2_v1',
                             'mission_start_enu_m': [7062.0, 6193.0, 30],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.airsim.cv_pawn.v1',
               'placement': {'position_enu_m': [7049.752, 6188.841, 3.0],
                             'resolved_position_enu_m': [7049.752, 6188.841, 3.0],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7062.0, 6193.0, 30],
                                         [7076.0, 6197.0, 28],
                                         [7090.0, 6207.0, 24],
                                         [7080.0, 6213.0, 30]]},
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7068.659, 6198.423, 0.0],
                  'radius_m': 185.626,
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.airsim.cv_pawn.v1',
               'entity_id': 'uav_l2_2_v1',
               'initial_pos_enu': [7049.752, 6188.841, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7062.0, 6193.0, 30],
                                      [7076.0, 6197.0, 28],
                                      [7090.0, 6207.0, 24],
                                      [7080.0, 6213.0, 30]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l2_2_v1_takeoff_entry',
                                          'entity_id': 'uav_l2_2_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7049.752, 6188.841, 3.0],
                                                              [7049.752, 6188.841, 24.0],
                                                              [7062.0, 6193.0, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l2_2_v1_landing_return',
                                          'entity_id': 'uav_l2_2_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7080.0, 6213.0, 30.0],
                                                              [7049.752, 6188.841, 22.0],
                                                              [7049.752, 6188.841, 3.0]]},
                               'type': 'move_entity'}],
