...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [73.333, -1.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [66.0, -5.0, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'building_id': 'urban_canyon_block_2',
                             'outward_normal_enu': [0.8, -0.6, 0.0],
                             'position_enu_m': [92.0, 9.0, 18],
                             'stand_off_m': 1.0},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [62.0, -7.0, 30], 'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[76.0, -3.0, 28], [90.0, 7.0, 24], [80.0, 13.0, 30]]}],
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_tower_multipath',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_multipath_drift',
                                          'entity_id': 'uav_l2_2_v1',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[62.0, -7.0, 30], [76.0, -3.0, 28], [90.0, 7.0, 24]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_corrected_route',
                                          'entity_id': 'uav_l2_2_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[90.0, 7.0, 24], [80.0, 13.0, 30]]},
                               'type': 'move_entity'}],
