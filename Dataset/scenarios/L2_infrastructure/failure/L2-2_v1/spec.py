...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7073.333, 6199.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7062.0, 6193.0, 30],
                             'resolved_position_enu_m': [7062.0, 6193.0, 30],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7076.0, 6197.0, 28], [7090.0, 6207.0, 24], [7080.0, 6213.0, 30]]}],
 'local_bounds': {'center_enu_m': [7077.667, 6202.333, 0.0],
                  'radius_m': 178.236,
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.airsim.cv_pawn.v1',
               'entity_id': 'uav_l2_2_v1',
               'initial_pos_enu': [7062.0, 6193.0, 30],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7076.0, 6197.0, 28], [7090.0, 6207.0, 24], [7080.0, 6213.0, 30]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_tower_multipath',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_multipath_drift',
                                          'entity_id': 'uav_l2_2_v1',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[7062.0, 6193.0, 30],
                                                              [7076.0, 6197.0, 28],
                                                              [7090.0, 6207.0, 24]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_corrected_route',
                                          'entity_id': 'uav_l2_2_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7090.0, 6207.0, 24], [7080.0, 6213.0, 30]]},
                               'type': 'move_entity'}],
