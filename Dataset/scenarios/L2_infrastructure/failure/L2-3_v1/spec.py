...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7083.667, 6210.667, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7070.0, 6212.0, 28],
                             'resolved_position_enu_m': [7070.0, 6212.0, 28],
                             'rotation_deg': {'yaw_deg': 110}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7079.0, 6205.0, 10], [7101.0, 6214.0, 10]]}],
 'local_bounds': {'center_enu_m': [7086.2, 6210.2, 0.0], 'radius_m': 177.773, 'source': 'scene_entities_and_routes'},
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.charger.cityops.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l2_3_v1',
               'initial_pos_enu': [7070.0, 6212.0, 28],
               'initial_rotation_deg': [0.0, 0.0, 110],
               'movement_waypoints': [[7079.0, 6205.0, 10], [7101.0, 6214.0, 10]],
