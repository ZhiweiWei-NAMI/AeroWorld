...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [83.667, 10.667, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [78.0, 4.0, 0], 'rotation_deg': {'yaw_deg': 90}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'initial_state': {'mode': 'available'},
               'logical_asset_id': 'facility.charger.cityops.v1',
               'placement': {'position_enu_m': [103.0, 16.0, 0], 'rotation_deg': {'yaw_deg': 90}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               'category': 'uav',
               ...
               'placement': {'position_enu_m': [70.0, 12.0, 28], 'rotation_deg': {'yaw_deg': 110}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[79.0, 5.0, 10], [101.0, 14.0, 10]]}],
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_primary_charger_offline',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_charger_inspection',
                                          'entity_id': 'uav_l2_3_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[70.0, 12.0, 28], [76.0, 7.0, 18], [79.0, 5.0, 10]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_backup_charger',
                                          'entity_id': 'uav_l2_3_v1',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[79.0, 5.0, 10], [90.0, 10.0, 18], [101.0, 14.0, 10]]},
                               'type': 'move_entity'},
