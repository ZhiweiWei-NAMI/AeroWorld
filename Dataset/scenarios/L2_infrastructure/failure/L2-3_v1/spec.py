"""
Auto-generated P0 scenario spec for: L2-3_v1
Event type: L2-3 — Charging Station Unavailable
Category: failure
CAAC ref: Non-emergency (facility issue)
SORA SAIL: II
Severity: minor
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L2-3_v1",
        category="failure.l2-3",
        description="Charger occupied, successful reallocation",
        duration_ticks=900,
    )
