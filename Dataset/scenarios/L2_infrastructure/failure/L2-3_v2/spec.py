...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [90.667, 16.167, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [85.0, 9.5, 0], 'rotation_deg': {'yaw_deg': 90}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'initial_state': {'mode': 'available'},
               'logical_asset_id': 'facility.charger.cityops.v1',
               'placement': {'position_enu_m': [110.0, 21.5, 0], 'rotation_deg': {'yaw_deg': 90}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               'category': 'uav',
               ...
               'placement': {'position_enu_m': [77.0, 17.5, 28], 'rotation_deg': {'yaw_deg': 110}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[86.0, 10.5, 10], [108.0, 19.5, 10]]}],
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_primary_charger_offline',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_charger_inspection',
                                          'entity_id': 'uav_l2_3_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[77.0, 17.5, 28], [83.0, 12.5, 18], [86.0, 10.5, 10]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'charger_unavailable', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_uav_backup_charger',
                                          'entity_id': 'uav_l2_3_v2',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[86.0, 10.5, 10], [97.0, 15.5, 18], [108.0, 19.5, 10]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'uav_inspects_charger', 'type': 'event_fired'}}],
