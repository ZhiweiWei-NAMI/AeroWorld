...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7087.502, 6214.342, 79.234],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7079.089, 6211.834, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l2_3_v2',
                             'mission_start_enu_m': [7077.0, 6217.5, 28],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7079.089, 6211.834, 3.0],
                             'resolved_position_enu_m': [7079.089, 6211.834, 3.0],
                             'rotation_deg': {'yaw_deg': 110}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7077.0, 6217.5, 28], [7086.0, 6210.5, 10], [7108.0, 6219.5, 10]]},
              {'activation_tick': 0,
               'category': 'facility',
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7087.502, 6214.342, 0.0],
                  'radius_m': 183.609,
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'facility.charger.cityops.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l2_3_v2',
               'initial_pos_enu': [7079.089, 6211.834, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 110],
               'movement_waypoints': [[7077.0, 6217.5, 28], [7086.0, 6210.5, 10], [7108.0, 6219.5, 10]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l2_3_v2_takeoff_entry',
                                          'entity_id': 'uav_l2_3_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7079.089, 6211.834, 3.0],
                                                              [7079.089, 6211.834, 24.0],
                                                              [7077.0, 6217.5, 28]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l2_3_v2_landing_return',
                                          'entity_id': 'uav_l2_3_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7108.0, 6219.5, 10.0],
                                                              [7079.089, 6211.834, 12.0],
                                                              [7079.089, 6211.834, 3.0]]},
                               'type': 'move_entity'}],
