...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [89.75, 16.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [104.0, 26.0, 4], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_7', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 82},
               'placement_mode': 'lane_anchor',
               'route_waypoints_enu_m': [[98.0, 26.0, 0], [112.0, 27.0, 0]]},
              {'activation_tick': 0,
               'category': 'vehicle',
               'entity_id': 'civilian_car_l2_5_b',
               'initial_state': {'mode': 'moving'},
               'logical_asset_id': 'vehicle.ground.boxcar.v1',
               'placement': {'edge_id': 'cg_edge_8', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 54},
               'placement_mode': 'lane_anchor',
               'route_waypoints_enu_m': [[106.0, 21.0, 0], [106.0, 35.0, 0]]},
              {'activation_tick': 0,
               'category': 'vehicle',
               'entity_id': 'police_unit_l2_5_v1',
               'initial_state': {'lights_on': True, 'mode': 'response'},
               'logical_asset_id': 'vehicle.emergency.police_suv.v1',
               'placement': {'edge_id': 'cg_edge_12', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 38},
               'placement_mode': 'lane_anchor',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'prop.traffic_control.signal_light.v1',
               'entity_id': 'traffic_signal_l2_5_v1',
               'initial_pos_enu': [104.0, 26.0, 4],
               'initial_rotation_deg': [0.0, 0.0, 0],
               'movement_waypoints': [],
               'visual_state': {'mode': 'green_cycle'}},
              {'asset_id': 'vehicle.ground.boxcar.v1',
               'entity_id': 'civilian_car_l2_5_a',
               'initial_pos_enu': [79.0, 26.0, 0],
               'initial_rotation_deg': [0.0, 0.0, 80],
               'movement_waypoints': [[98.0, 26.0, 0], [112.0, 27.0, 0]],
               'visual_state': {'mode': 'moving'}},
              {'asset_id': 'vehicle.ground.boxcar.v1',
               'entity_id': 'civilian_car_l2_5_b',
               'initial_pos_enu': [108.0, 2.0, 0],
               'initial_rotation_deg': [0.0, 0.0, 5],
               'movement_waypoints': [[106.0, 21.0, 0], [106.0, 35.0, 0]],
               'visual_state': {'mode': 'moving'}},
              {'asset_id': 'vehicle.emergency.police_suv.v1',
               'entity_id': 'police_unit_l2_5_v1',
               'initial_pos_enu': [68.0, 10.0, 0],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_signal_all_red',
                 ...
                 {'actions': [{'params': {'action_id': 'move_car_a_confused_stop',
                                          'entity_id': 'civilian_car_l2_5_a',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[79.0, 26.0, 0], [99.0, 26.0, 0]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_car_b_confused_stop',
                                          'entity_id': 'civilian_car_l2_5_b',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[108.0, 2.0, 0], [106.0, 22.0, 0]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'signal_all_red_fault', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_police_to_intersection',
                                          'entity_id': 'police_unit_l2_5_v1',
                                          'velocity_mps': 12.0,
                                          'waypoints_enu_m': [[68.0, 10.0, 0], [97.0, 22.0, 0]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'traffic_confusion', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_car_a_released',
                                          'entity_id': 'civilian_car_l2_5_a',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[99.0, 26.0, 0], [120.0, 27.0, 0]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_car_b_released',
                                          'entity_id': 'civilian_car_l2_5_b',
                                          'velocity_mps': 5.5,
                                          'waypoints_enu_m': [[106.0, 22.0, 0], [106.0, 41.0, 0]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'police_arrival', 'type': 'event_fired'}}],
