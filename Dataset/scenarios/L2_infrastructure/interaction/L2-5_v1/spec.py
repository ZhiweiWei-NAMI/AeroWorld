...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7105.69, 6207.178, 136.979],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'contract_inspect_uav': {'corridor_role': 'inspect_observer',
                                        ...
                                        'loop_route_enu_m': [[7127.474, 6147.602, 18.0],
               ...
               'placement': {'position_enu_m': [7127.474, 6147.602, 18.0],
                             'resolved_position_enu_m': [7127.474, 6147.602, 18.0],
                             'rotation_deg': {'yaw_deg': 45.0}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7109.873, 6188.625, 18.0],
                                         [7127.474, 6147.602, 18.0],
                                         [7109.873, 6188.625, 18.0]],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'altitude_layer_m': 18.0,
                             'center_enu_m': [7118.673, 6168.113, 18.0],
                             'extent_m': [22.32, 4.0, 4.0],
                             'resolved_position_enu_m': [7118.673, 6168.113, 18.0],
                             'rotation_deg': {'pitch_deg': 0.0, 'roll_deg': 0.0, 'yaw_deg': 113.222},
                             'scale_xyz': [44.639, 8.0, 8.0],
                             'segment_end_enu_m': [7109.873, 6188.625, 18.0],
                             'segment_start_enu_m': [7127.474, 6147.602, 18.0],
                             'size_m': [44.639, 8.0, 8.0],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'altitude_layer_m': 18.0,
                             ...
                             'extent_m': [22.32, 4.0, 4.0],
                             'resolved_position_enu_m': [7118.673, 6168.113, 18.0],
                             'rotation_deg': {'pitch_deg': 0.0, 'roll_deg': 0.0, 'yaw_deg': -66.778},
                             'scale_xyz': [44.639, 8.0, 8.0],
              ...
              {'activation_tick': 0,
               ...
               'placement_mode': 'box_volume',
               'query_tags': ['UAVCorridor', 'HighAltitudeCorridor', 'event_semantic']}],
 'local_bounds': {'center_enu_m': [7105.69, 6207.178, 0.0],
                  'radius_m': 223.434,
 ...
 'validation_rules': [{'description': 'traffic_signal_l2_5_v1 is declared before event_script references it in '
                      ...
                      {'contract': {'background_semantics': {'pedestrian_role': 'crosswalk wait/cross',
                                    ...
                                    'capture_boundary': {'anchor_entity_roles': ['capture_boundary',
                                                                                 'hazard_zone',
                                                                                 'airspace_constraint'],
                                                         'boundary_id': 'capture_boundary.L2-5_v1.primary',
...
SPEC_DATA = {'category': 'infrastructure',
 ...
 'entities': [{'asset_id': 'prop.traffic_control.signal_light.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'u_inspect_l2_5_v1',
               'initial_pos_enu': [7127.474, 6147.602, 18.0],
               'initial_rotation_deg': [0.0, 0.0, 45.0],
               'movement_waypoints': [[7109.873, 6188.625, 18.0],
                                      [7127.474, 6147.602, 18.0],
                                      [7109.873, 6188.625, 18.0]],
              ...
              {'asset_id': 'semantic.uav_corridor.segment.v1',
               'entity_id': 'corridor_l2_5_v1_u_inspect_l2_5_v1_00',
               'initial_pos_enu': [7118.673, 6168.113, 18.0],
               'initial_rotation_deg': [0.0, 0.0, 113.222],
               'movement_waypoints': [],
               'visual_state': {'mode': 'semantic_corridor'}},
              {'asset_id': 'semantic.uav_corridor.segment.v1',
               'entity_id': 'corridor_l2_5_v1_u_inspect_l2_5_v1_01',
               'initial_pos_enu': [7118.673, 6168.113, 18.0],
               'initial_rotation_deg': [0.0, 0.0, -66.778],
               'movement_waypoints': [],
               'visual_state': {'mode': 'semantic_corridor'}},
              {'asset_id': 'semantic.uav_corridor.segment.v1',
               'entity_id': 'corridor_l2_5_v1_u_inspect_l2_5_v1_02',
