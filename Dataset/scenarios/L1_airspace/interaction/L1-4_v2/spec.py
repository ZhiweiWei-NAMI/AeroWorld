...
SPEC_DATA = {'category': 'airspace',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                              ...
                              {'params': {'action_id': 'move_corridor_secondary',
                                          'entity_id': 'uav_l1_4_v2_secondary',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7095.0, 6218.0, 32], [14111.0, 12448.0, 32]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_corridor_tertiary',
                                          'entity_id': 'uav_l1_4_v2_tertiary',
                                          'velocity_mps': 6.5,
                                          'waypoints_enu_m': [[7077.0, 6226.0, 34], [14113.0, 12451.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_4_v2_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[7108.0, 6246.0, 30], [14102.0, 12450.0, 34]]},
                               'type': 'move_entity'},
                              ...
                              {'params': {'action_id': 'move_corridor_reroute_secondary',
                                          'entity_id': 'uav_l1_4_v2_secondary',
                                          'velocity_mps': 8.5,
                                          'waypoints_enu_m': [[14111.0, 12448.0, 32], [14131.0, 12466.0, 38]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_4_v2_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[14102.0, 12450.0, 34], [7084.0, 6261.0, 34]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_corridor_resume_tertiary',
                                          'entity_id': 'uav_l1_4_v2_tertiary',
                                          'velocity_mps': 7.5,
                                          'waypoints_enu_m': [[14113.0, 12451.0, 34], [14097.0, 12464.0, 34]]},
                               'type': 'move_entity'}],
