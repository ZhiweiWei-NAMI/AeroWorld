"""
Auto-generated P0 scenario spec for: L1-4_v2
Event type: L1-4 — Airspace Corridor Congestion
Category: violation
CAAC ref: Non-emergency (traffic management)
SORA SAIL: II
Severity: major
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L1-4_v2",
        category="violation.l1-4",
        description="Severe congestion, one UAV forced to divert",
        duration_ticks=900,
    )
