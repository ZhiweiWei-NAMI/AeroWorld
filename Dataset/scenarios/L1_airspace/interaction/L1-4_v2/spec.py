...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [94.0, 32.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [89.0, 36.0, 30], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[108.0, 46.0, 30], [84.0, 61.0, 34]]},
              {'activation_tick': 0,
               'category': 'airspace_constraint',
               'entity_id': 'nfz_l1_4_v2',
               'initial_state': {},
               'logical_asset_id': 'trigger.hazard.generic.box.v1',
               'placement': {'center_enu_m': [115.0, 50.0, 28], 'extent_m': [14.0, 10.0, 14.0]},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [95.0, 18.0, 32], 'rotation_deg': {'yaw_deg': 20}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               'category': 'uav',
               ...
               'placement': {'position_enu_m': [77.0, 26.0, 34], 'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'airspace',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                              ...
                              {'params': {'action_id': 'move_corridor_secondary',
                                          'entity_id': 'uav_l1_4_v2_secondary',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[95.0, 18.0, 32], [111.0, 48.0, 32]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_corridor_tertiary',
                                          'entity_id': 'uav_l1_4_v2_tertiary',
                                          'velocity_mps': 6.5,
                                          'waypoints_enu_m': [[77.0, 26.0, 34], [113.0, 51.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_4_v2_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[108.0, 46.0, 30], [102.0, 50.0, 34]]},
                               'type': 'move_entity'},
                              ...
                              {'params': {'action_id': 'move_corridor_reroute_secondary',
                                          'entity_id': 'uav_l1_4_v2_secondary',
                                          'velocity_mps': 8.5,
                                          'waypoints_enu_m': [[111.0, 48.0, 32], [131.0, 66.0, 38]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_4_v2_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[102.0, 50.0, 34], [84.0, 61.0, 34]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_corridor_resume_tertiary',
                                          'entity_id': 'uav_l1_4_v2_tertiary',
                                          'velocity_mps': 7.5,
                                          'waypoints_enu_m': [[113.0, 51.0, 34], [97.0, 64.0, 34]]},
                               'type': 'move_entity'}],
