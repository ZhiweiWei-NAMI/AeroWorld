...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7094.266, 6234.764, 114.918],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7083.403, 6233.371, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l1_4_v2_primary',
                             'mission_start_enu_m': [7089.0, 6236.0, 30],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7083.403, 6233.371, 3.0],
                             'resolved_position_enu_m': [7083.403, 6233.371, 3.0],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7089.0, 6236.0, 30], [7108.0, 6246.0, 30], [7084.0, 6261.0, 34]]},
              {'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'initial_state': {'mode': 'preflight_on_pad'},
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7092.712, 6216.186, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l1_4_v2_secondary',
                             'mission_start_enu_m': [7095.0, 6218.0, 32],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.airsim.cv_pawn.v1',
               'placement': {'position_enu_m': [7092.712, 6216.186, 3.0],
                             'resolved_position_enu_m': [7092.712, 6216.186, 3.0],
                             'rotation_deg': {'yaw_deg': 20}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7095.0, 6218.0, 32]]},
              {'activation_tick': 0,
               'category': 'uav',
               'entity_id': 'uav_l1_4_v2_tertiary',
               'initial_state': {'mode': 'preflight_on_pad'},
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7083.211, 6209.003, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l1_4_v2_tertiary',
                             'mission_start_enu_m': [7077.0, 6226.0, 34],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.airsim.flying_pawn.v1',
               'placement': {'position_enu_m': [7083.211, 6209.003, 3.0],
                             'resolved_position_enu_m': [7083.211, 6209.003, 3.0],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7077.0, 6226.0, 34]]},
              {'activation_tick': 0,
               'category': 'facility',
              ...
              {'activation_tick': 0,
               ...
               'placement_mode': 'pad_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7094.266, 6234.764, 0.0],
                  'radius_m': 208.22,
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_4_v2_primary',
               'initial_pos_enu': [7083.403, 6233.371, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7089.0, 6236.0, 30], [7108.0, 6246.0, 30], [7084.0, 6261.0, 34]],
              ...
              {'asset_id': 'uav.airsim.cv_pawn.v1',
               'entity_id': 'uav_l1_4_v2_secondary',
               'initial_pos_enu': [7092.712, 6216.186, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 20],
               'movement_waypoints': [[7095.0, 6218.0, 32]],
               'visual_state': {'mode': 'preflight_on_pad'}},
              {'asset_id': 'uav.airsim.flying_pawn.v1',
               'entity_id': 'uav_l1_4_v2_tertiary',
               'initial_pos_enu': [7083.211, 6209.003, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7077.0, 6226.0, 34]],
               'visual_state': {'mode': 'preflight_on_pad'}},
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l1_4_v2_primary_takeoff_entry',
                                          'entity_id': 'uav_l1_4_v2_primary',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7083.403, 6233.371, 3.0],
                                                              [7083.403, 6233.371, 24.0],
                                                              [7089.0, 6236.0, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v2_secondary_takeoff_entry',
                                          'entity_id': 'uav_l1_4_v2_secondary',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7092.712, 6216.186, 3.0],
                                                              [7092.712, 6216.186, 24.0],
                                                              [7095.0, 6218.0, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v2_tertiary_takeoff_entry',
                                          'entity_id': 'uav_l1_4_v2_tertiary',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7083.211, 6209.003, 3.0],
                                                              [7083.211, 6209.003, 24.0],
                                                              [7077.0, 6226.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v2_primary_landing_return',
                                          'entity_id': 'uav_l1_4_v2_primary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7084.0, 6261.0, 34.0],
                                                              [7083.403, 6233.371, 22.0],
                                                              [7083.403, 6233.371, 3.0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v2_secondary_landing_return',
                                          'entity_id': 'uav_l1_4_v2_secondary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7131.0, 6266.0, 38.0],
                                                              [7092.712, 6216.186, 22.0],
                                                              [7092.712, 6216.186, 3.0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v2_tertiary_landing_return',
                                          'entity_id': 'uav_l1_4_v2_tertiary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7097.0, 6264.0, 34.0],
                                                              [7083.211, 6209.003, 22.0],
                                                              [7083.211, 6209.003, 3.0]]},
                               'type': 'move_entity'}],
