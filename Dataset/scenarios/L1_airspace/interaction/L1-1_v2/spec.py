...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7055.36, 6225.256, 75.415],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7056.389, 6219.476, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l1_1_v2_primary',
                             'mission_start_enu_m': [7046.5, 6216.0, 32],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7056.389, 6219.476, 3.0],
                             'resolved_position_enu_m': [7056.389, 6219.476, 3.0],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7046.5, 6216.0, 32], [7065.5, 6226.0, 32], [7041.5, 6241.0, 34]]},
              {'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7055.36, 6225.256, 0.0],
                  'radius_m': 180.976,
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_1_v2_primary',
               'initial_pos_enu': [7056.389, 6219.476, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7046.5, 6216.0, 32], [7065.5, 6226.0, 32], [7041.5, 6241.0, 34]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l1_1_v2_primary_takeoff_entry',
                                          'entity_id': 'uav_l1_1_v2_primary',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7056.389, 6219.476, 3.0],
                                                              [7056.389, 6219.476, 24.0],
                                                              [7046.5, 6216.0, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_1_v2_primary_landing_return',
                                          'entity_id': 'uav_l1_1_v2_primary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7041.5, 6241.0, 34.0],
                                                              [7056.389, 6219.476, 22.0],
                                                              [7056.389, 6219.476, 3.0]]},
                               'type': 'move_entity'}],
