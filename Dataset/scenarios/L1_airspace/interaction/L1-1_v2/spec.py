"""
Auto-generated P0 scenario spec for: L1-1_v2
Event type: L1-1 — UAV Geofence Violation
Category: violation
CAAC ref: CAAC-10 (entering prohibited/danger/restricted zones)
SORA SAIL: III-IV
Severity: minor
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L1-1_v2",
        category="violation.l1-1",
        description="Boundary oscillation, repeated entry/exit",
        duration_ticks=900,
    )
