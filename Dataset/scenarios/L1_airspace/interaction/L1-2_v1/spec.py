...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [68.0, 27.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [55.0, 20.0, 34], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[74.0, 30.0, 34], [50.0, 45.0, 34]]},
              {'activation_tick': 0,
               'category': 'airspace_constraint',
               'entity_id': 'nfz_l1_2_v1',
               'initial_state': {},
               'logical_asset_id': 'trigger.hazard.generic.box.v1',
               'placement': {'center_enu_m': [81.0, 34.0, 28], 'extent_m': [14.0, 10.0, 14.0]},
 ...
 'scenario_id': 'L1-2_v1',
 'spawn_sequencing': [{'entity_id': 'uav_l1_2_v1_primary', 'tick': 0}, {'entity_id': 'nfz_l1_2_v1', 'tick': 0}],
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_2_v1_primary',
               'initial_pos_enu': [55.0, 20.0, 34],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[74.0, 30.0, 34], [50.0, 45.0, 34]],
               'visual_state': {'mode': 'patrol'}},
              {'asset_id': 'trigger.hazard.generic.box.v1',
               'entity_id': 'nfz_l1_2_v1',
               'initial_pos_enu': [81.0, 34.0, 28],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                                          'entity_id': 'uav_l1_2_v1_primary',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[55.0, 20.0, 34], [70.0, 28.0, 34], [74.0, 30.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_altitude_recover',
                                          'entity_id': 'uav_l1_2_v1_primary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[74.0, 30.0, 34], [71.0, 34.0, 42], [66.0, 38.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_2_v1_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[68.0, 34.0, 38], [50.0, 45.0, 34]]},
                               'type': 'move_entity'}],
