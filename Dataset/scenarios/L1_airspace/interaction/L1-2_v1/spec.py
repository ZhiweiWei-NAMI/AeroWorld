...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7068.0, 6227.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7055.0, 6220.0, 34],
                             'resolved_position_enu_m': [7055.0, 6220.0, 34],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7074.0, 6230.0, 34], [7050.0, 6245.0, 34]]},
              {'activation_tick': 0,
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_2_v1_primary',
               'initial_pos_enu': [7055.0, 6220.0, 34],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7074.0, 6230.0, 34], [7050.0, 6245.0, 34]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_2_v1_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[14068.0, 12434.0, 38], [7050.0, 6245.0, 34]]},
                               'type': 'move_entity'}],
