"""
Auto-generated P0 scenario spec for: L1-2_v1
Event type: L1-2 — UAV Altitude Deviation
Category: violation
CAAC ref: Non-emergency (altitude deviation)
SORA SAIL: II-III
Severity: minor
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L1-2_v1",
        category="violation.l1-2",
        description="Gradual drift below assigned corridor",
        duration_ticks=900,
    )
