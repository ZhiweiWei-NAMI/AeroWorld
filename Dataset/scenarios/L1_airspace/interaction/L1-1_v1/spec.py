...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7051.0, 6219.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7038.0, 6212.0, 30],
                             'resolved_position_enu_m': [7038.0, 6212.0, 30],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7057.0, 6222.0, 30], [7033.0, 6237.0, 34]]},
              {'activation_tick': 0,
 ...
 'local_bounds': {'center_enu_m': [7048.0, 6224.25, 0.0], 'radius_m': 179.687, 'source': 'scene_entities_and_routes'},
 'map_ref': {'coordinate_frame': 'ENU',
             'geo_reference': {'alt': 24.0, 'lat': 30.5609, 'lon': 114.3627},
             'map_id': 'donghu_road_topo'},
 'scenario_id': 'L1-1_v1',
 'spawn_sequencing': [{'entity_id': 'uav_l1_1_v1_primary', 'tick': 0}, {'entity_id': 'nfz_l1_1_v1', 'tick': 0}],
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_1_v1_primary',
               'initial_pos_enu': [7038.0, 6212.0, 30],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7057.0, 6222.0, 30], [7033.0, 6237.0, 34]],
