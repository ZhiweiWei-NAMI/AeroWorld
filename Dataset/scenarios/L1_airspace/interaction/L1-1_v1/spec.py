...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [51.0, 19.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [38.0, 12.0, 30], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[57.0, 22.0, 30], [33.0, 37.0, 34]]},
              {'activation_tick': 0,
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_1_v1_primary',
               'initial_pos_enu': [38.0, 12.0, 30],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[57.0, 22.0, 30], [33.0, 37.0, 34]],
               'visual_state': {'mode': 'patrol'}},
              {'asset_id': 'trigger.no_fly.box.v1',
               'entity_id': 'nfz_l1_1_v1',
               'initial_pos_enu': [64.0, 26.0, 28],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                                          'entity_id': 'uav_l1_1_v1_primary',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[38.0, 12.0, 30], [53.0, 20.0, 30], [57.0, 22.0, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_1_v1_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[57.0, 22.0, 30], [51.0, 26.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_1_v1_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[51.0, 26.0, 34], [33.0, 37.0, 34]]},
                               'type': 'move_entity'}],
