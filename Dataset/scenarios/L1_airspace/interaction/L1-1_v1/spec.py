...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7042.777, 6221.172, 76.559],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7034.961, 6215.212, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l1_1_v1_primary',
                             'mission_start_enu_m': [7038.0, 6212.0, 30],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7034.961, 6215.212, 3.0],
                             'resolved_position_enu_m': [7034.961, 6215.212, 3.0],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7038.0, 6212.0, 30], [7057.0, 6222.0, 30], [7033.0, 6237.0, 34]]},
              {'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7042.777, 6221.172, 0.0],
                  'radius_m': 181.765,
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_1_v1_primary',
               'initial_pos_enu': [7034.961, 6215.212, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7038.0, 6212.0, 30], [7057.0, 6222.0, 30], [7033.0, 6237.0, 34]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l1_1_v1_primary_takeoff_entry',
                                          'entity_id': 'uav_l1_1_v1_primary',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7034.961, 6215.212, 3.0],
                                                              [7034.961, 6215.212, 24.0],
                                                              [7038.0, 6212.0, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_approach',
                                          'entity_id': 'uav_l1_1_v1_primary',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[7038.0, 6212.0, 30],
                                                              [7053.0, 6220.0, 30],
                                                              [7057.0, 6222.0, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_1_v1_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[7057.0, 6222.0, 30], [7051.0, 6226.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_1_v1_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[7051.0, 6226.0, 34], [7033.0, 6237.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_1_v1_primary_landing_return',
                                          'entity_id': 'uav_l1_1_v1_primary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7033.0, 6237.0, 34.0],
                                                              [7034.961, 6215.212, 22.0],
                                                              [7034.961, 6215.212, 3.0]]},
                               'type': 'move_entity'}],
