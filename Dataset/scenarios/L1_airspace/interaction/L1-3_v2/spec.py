...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [93.333, 34.667, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [72.0, 28.0, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[91.0, 38.0, 32], [67.0, 53.0, 34]]},
              {'activation_tick': 0,
               'category': 'airspace_constraint',
               'entity_id': 'nfz_l1_3_v2',
               'initial_state': {},
               'logical_asset_id': 'trigger.no_fly.box.v1',
               'placement': {'center_enu_m': [98.0, 42.0, 28], 'extent_m': [14.0, 10.0, 14.0]},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [110.0, 34.0, 29], 'rotation_deg': {'yaw_deg': 215}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[101.0, 40.0, 29]]}],
...
SPEC_DATA = {'category': 'airspace',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_3_v2_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[91.0, 38.0, 32], [85.0, 42.0, 36]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_3_v2_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[85.0, 42.0, 36], [67.0, 53.0, 34]]},
                               'type': 'move_entity'}],
