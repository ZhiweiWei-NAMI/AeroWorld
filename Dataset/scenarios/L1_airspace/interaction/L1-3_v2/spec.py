"""
Auto-generated P0 scenario spec for: L1-3_v2
Event type: L1-3 — Non-Cooperative UAV Intrusion
Category: violation
CAAC ref: CAAC-10 (unauthorized entry)
SORA SAIL: IV-V
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L1-3_v2",
        category="violation.l1-3",
        description="Intruder ignores warnings, forced interdiction",
        duration_ticks=900,
    )
