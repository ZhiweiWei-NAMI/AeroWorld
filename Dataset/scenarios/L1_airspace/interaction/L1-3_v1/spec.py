...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7082.212, 6229.099, 89.887],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7068.668, 6208.316, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l1_3_v1_primary',
                             'mission_start_enu_m': [7063.5, 6224.0, 30],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7068.668, 6208.316, 3.0],
                             'resolved_position_enu_m': [7068.668, 6208.316, 3.0],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7063.5, 6224.0, 30], [7082.5, 6234.0, 30], [7058.5, 6249.0, 34]]},
              {'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'initial_state': {'mode': 'preflight_on_pad'},
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7103.342, 6231.193, 3.0],
                             'home_pad_entity_id': 'pad_home_intruder_l1_3_v1',
                             'mission_start_enu_m': [7101.5, 6230.0, 29],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.airsim.flying_pawn.v1',
               'placement': {'position_enu_m': [7103.342, 6231.193, 3.0],
                             'resolved_position_enu_m': [7103.342, 6231.193, 3.0],
                             'rotation_deg': {'yaw_deg': 215}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7101.5, 6230.0, 29], [7092.5, 6236.0, 29]]},
              {'activation_tick': 0,
               'category': 'facility',
              ...
              {'activation_tick': 0,
               ...
               'placement_mode': 'pad_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7082.212, 6229.099, 0.0],
                  'radius_m': 190.957,
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_3_v1_primary',
               'initial_pos_enu': [7068.668, 6208.316, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7063.5, 6224.0, 30], [7082.5, 6234.0, 30], [7058.5, 6249.0, 34]],
              ...
              {'asset_id': 'uav.airsim.flying_pawn.v1',
               'entity_id': 'intruder_l1_3_v1',
               'initial_pos_enu': [7103.342, 6231.193, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 215],
               'movement_waypoints': [[7101.5, 6230.0, 29], [7092.5, 6236.0, 29]],
               'visual_state': {'mode': 'preflight_on_pad'}},
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l1_3_v1_primary_takeoff_entry',
                                          'entity_id': 'uav_l1_3_v1_primary',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7068.668, 6208.316, 3.0],
                                                              [7068.668, 6208.316, 24.0],
                                                              [7063.5, 6224.0, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_intruder_l1_3_v1_takeoff_entry',
                                          'entity_id': 'intruder_l1_3_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7103.342, 6231.193, 3.0],
                                                              [7103.342, 6231.193, 24.0],
                                                              [7101.5, 6230.0, 29]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_3_v1_primary_landing_return',
                                          'entity_id': 'uav_l1_3_v1_primary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7058.5, 6249.0, 34.0],
                                                              [7068.668, 6208.316, 22.0],
                                                              [7068.668, 6208.316, 3.0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_intruder_l1_3_v1_landing_return',
                                          'entity_id': 'intruder_l1_3_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7092.5, 6236.0, 29.0],
                                                              [7103.342, 6231.193, 22.0],
                                                              [7103.342, 6231.193, 3.0]]},
                               'type': 'move_entity'}],
