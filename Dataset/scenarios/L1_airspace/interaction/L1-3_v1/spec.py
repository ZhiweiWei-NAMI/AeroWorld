...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [84.833, 30.667, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [63.5, 24.0, 30], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[82.5, 34.0, 30], [58.5, 49.0, 34]]},
              {'activation_tick': 0,
               'category': 'airspace_constraint',
               'entity_id': 'nfz_l1_3_v1',
               'initial_state': {},
               'logical_asset_id': 'trigger.no_fly.box.v1',
               'placement': {'center_enu_m': [89.5, 38.0, 28], 'extent_m': [14.0, 10.0, 14.0]},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [101.5, 30.0, 29], 'rotation_deg': {'yaw_deg': 215}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[92.5, 36.0, 29]]}],
...
SPEC_DATA = {'category': 'airspace',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_3_v1_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[82.5, 34.0, 30], [76.5, 38.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_3_v1_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[76.5, 38.0, 34], [58.5, 49.0, 34]]},
                               'type': 'move_entity'}],
