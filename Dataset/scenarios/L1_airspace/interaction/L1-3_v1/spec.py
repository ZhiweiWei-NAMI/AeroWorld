...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7084.833, 6230.667, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7063.5, 6224.0, 30],
                             'resolved_position_enu_m': [7063.5, 6224.0, 30],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7082.5, 6234.0, 30], [7058.5, 6249.0, 34]]},
              {'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7101.5, 6230.0, 29],
                             'resolved_position_enu_m': [7101.5, 6230.0, 29],
                             'rotation_deg': {'yaw_deg': 215}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[14092.5, 12436.0, 29]]}],
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_3_v1_primary',
               'initial_pos_enu': [7063.5, 6224.0, 30],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7082.5, 6234.0, 30], [7058.5, 6249.0, 34]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                              ...
                              {'params': {'action_id': 'move_intruder_converge',
                                          'entity_id': 'intruder_l1_3_v1',
                                          'velocity_mps': 10.0,
                                          'waypoints_enu_m': [[7101.5, 6230.0, 29], [14092.5, 12436.0, 29]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_3_v1_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[7082.5, 6234.0, 30], [14076.5, 12438.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_3_v1_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[14076.5, 12438.0, 34], [7058.5, 6249.0, 34]]},
                               'type': 'move_entity'}],
