...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7092.5, 6236.0, 29]]}],
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
              ...
              {'asset_id': 'uav.airsim.flying_pawn.v1',
               ...
               'movement_waypoints': [[7092.5, 6236.0, 29]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                              ...
                              {'params': {'action_id': 'move_intruder_converge',
                                          'entity_id': 'intruder_l1_3_v1',
                                          'velocity_mps': 10.0,
                                          'waypoints_enu_m': [[7101.5, 6230.0, 29], [7092.5, 6236.0, 29]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_3_v1_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[7082.5, 6234.0, 30], [7076.5, 6238.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_3_v1_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[7076.5, 6238.0, 34], [7058.5, 6249.0, 34]]},
                               'type': 'move_entity'}],
