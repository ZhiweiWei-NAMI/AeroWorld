...
SPEC_DATA = {'category': 'airspace',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                              ...
                              {'params': {'action_id': 'move_corridor_secondary',
                                          'entity_id': 'uav_l1_4_v1_secondary',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7086.5, 6214.0, 32], [7102.5, 6244.0, 32]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_corridor_tertiary',
                                          'entity_id': 'uav_l1_4_v1_tertiary',
                                          'velocity_mps': 6.5,
                                          'waypoints_enu_m': [[7068.5, 6222.0, 34], [7104.5, 6247.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_4_v1_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[7099.5, 6242.0, 34], [7093.5, 6246.0, 38]]},
                               'type': 'move_entity'},
                              ...
                              {'params': {'action_id': 'move_corridor_reroute_secondary',
                                          'entity_id': 'uav_l1_4_v1_secondary',
                                          'velocity_mps': 8.5,
                                          'waypoints_enu_m': [[7102.5, 6244.0, 32], [7122.5, 6262.0, 38]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_4_v1_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[7093.5, 6246.0, 38], [7075.5, 6257.0, 34]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_corridor_resume_tertiary',
                                          'entity_id': 'uav_l1_4_v1_tertiary',
                                          'velocity_mps': 7.5,
                                          'waypoints_enu_m': [[7104.5, 6247.0, 34], [7088.5, 6260.0, 34]]},
                               'type': 'move_entity'}],
