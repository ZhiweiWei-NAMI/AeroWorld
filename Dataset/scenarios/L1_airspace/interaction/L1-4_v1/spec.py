...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7085.5, 6228.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7080.5, 6232.0, 34],
                             'resolved_position_enu_m': [7080.5, 6232.0, 34],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7099.5, 6242.0, 34], [7075.5, 6257.0, 34]]},
              {'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7086.5, 6214.0, 32],
                             'resolved_position_enu_m': [7086.5, 6214.0, 32],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7068.5, 6222.0, 34],
                             'resolved_position_enu_m': [7068.5, 6222.0, 34],
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_4_v1_primary',
               'initial_pos_enu': [7080.5, 6232.0, 34],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7099.5, 6242.0, 34], [7075.5, 6257.0, 34]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_boundary_approach',
                                          'entity_id': 'uav_l1_4_v1_primary',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[7080.5, 6232.0, 34],
                                                              [14095.5, 12440.0, 34],
                                                              [7099.5, 6242.0, 34]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_corridor_secondary',
                                          'entity_id': 'uav_l1_4_v1_secondary',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7086.5, 6214.0, 32], [14102.5, 12444.0, 32]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_corridor_tertiary',
                                          'entity_id': 'uav_l1_4_v1_tertiary',
                                          'velocity_mps': 6.5,
                                          'waypoints_enu_m': [[7068.5, 6222.0, 34], [14104.5, 12447.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_avoidance',
                                          'entity_id': 'uav_l1_4_v1_primary',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[7099.5, 6242.0, 34], [14093.5, 12446.0, 38]]},
                               'type': 'move_entity'},
                              ...
                              {'params': {'action_id': 'move_corridor_reroute_secondary',
                                          'entity_id': 'uav_l1_4_v1_secondary',
                                          'velocity_mps': 8.5,
                                          'waypoints_enu_m': [[14102.5, 12444.0, 32], [14122.5, 12462.0, 38]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_boundary_return_safe',
                                          'entity_id': 'uav_l1_4_v1_primary',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[14093.5, 12446.0, 38], [7075.5, 6257.0, 34]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_corridor_resume_tertiary',
                                          'entity_id': 'uav_l1_4_v1_tertiary',
                                          'velocity_mps': 7.5,
                                          'waypoints_enu_m': [[14104.5, 12447.0, 34], [14088.5, 12460.0, 34]]},
                               'type': 'move_entity'}],
