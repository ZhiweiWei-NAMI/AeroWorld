...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7086.816, 6231.29, 113.265],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7086.669, 6214.392, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l1_4_v1_primary',
                             'mission_start_enu_m': [7080.5, 6232.0, 34],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7086.669, 6214.392, 3.0],
                             'resolved_position_enu_m': [7086.669, 6214.392, 3.0],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7080.5, 6232.0, 34], [7099.5, 6242.0, 34], [7075.5, 6257.0, 34]]},
              {'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'initial_state': {'mode': 'preflight_on_pad'},
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7081.297, 6230.31, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l1_4_v1_secondary',
                             'mission_start_enu_m': [7086.5, 6214.0, 32],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.airsim.cv_pawn.v1',
               'placement': {'position_enu_m': [7081.297, 6230.31, 3.0],
                             'resolved_position_enu_m': [7081.297, 6230.31, 3.0],
                             'rotation_deg': {'yaw_deg': 20}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7086.5, 6214.0, 32]]},
              {'activation_tick': 0,
               'category': 'uav',
               'entity_id': 'uav_l1_4_v1_tertiary',
               'initial_state': {'mode': 'preflight_on_pad'},
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7073.736, 6205.805, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l1_4_v1_tertiary',
                             'mission_start_enu_m': [7068.5, 6222.0, 34],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.airsim.flying_pawn.v1',
               'placement': {'position_enu_m': [7073.736, 6205.805, 3.0],
                             'resolved_position_enu_m': [7073.736, 6205.805, 3.0],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7068.5, 6222.0, 34]]},
              {'activation_tick': 0,
               'category': 'facility',
              ...
              {'activation_tick': 0,
               ...
               'placement_mode': 'pad_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7086.816, 6231.29, 0.0],
                  'radius_m': 207.079,
...
SPEC_DATA = {'category': 'airspace',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l1_4_v1_primary',
               'initial_pos_enu': [7086.669, 6214.392, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7080.5, 6232.0, 34], [7099.5, 6242.0, 34], [7075.5, 6257.0, 34]],
              ...
              {'asset_id': 'uav.airsim.cv_pawn.v1',
               'entity_id': 'uav_l1_4_v1_secondary',
               'initial_pos_enu': [7081.297, 6230.31, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 20],
               'movement_waypoints': [[7086.5, 6214.0, 32]],
               'visual_state': {'mode': 'preflight_on_pad'}},
              {'asset_id': 'uav.airsim.flying_pawn.v1',
               'entity_id': 'uav_l1_4_v1_tertiary',
               'initial_pos_enu': [7073.736, 6205.805, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7068.5, 6222.0, 34]],
               'visual_state': {'mode': 'preflight_on_pad'}},
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l1_4_v1_primary_takeoff_entry',
                                          'entity_id': 'uav_l1_4_v1_primary',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7086.669, 6214.392, 3.0],
                                                              [7086.669, 6214.392, 24.0],
                                                              [7080.5, 6232.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v1_secondary_takeoff_entry',
                                          'entity_id': 'uav_l1_4_v1_secondary',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7081.297, 6230.31, 3.0],
                                                              [7081.297, 6230.31, 24.0],
                                                              [7086.5, 6214.0, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v1_tertiary_takeoff_entry',
                                          'entity_id': 'uav_l1_4_v1_tertiary',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7073.736, 6205.805, 3.0],
                                                              [7073.736, 6205.805, 24.0],
                                                              [7068.5, 6222.0, 34]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v1_primary_landing_return',
                                          'entity_id': 'uav_l1_4_v1_primary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7075.5, 6257.0, 34.0],
                                                              [7086.669, 6214.392, 22.0],
                                                              [7086.669, 6214.392, 3.0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v1_secondary_landing_return',
                                          'entity_id': 'uav_l1_4_v1_secondary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7122.5, 6262.0, 38.0],
                                                              [7081.297, 6230.31, 22.0],
                                                              [7081.297, 6230.31, 3.0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l1_4_v1_tertiary_landing_return',
                                          'entity_id': 'uav_l1_4_v1_tertiary',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7088.5, 6260.0, 34.0],
                                                              [7073.736, 6205.805, 22.0],
                                                              [7073.736, 6205.805, 3.0]]},
                               'type': 'move_entity'}],
