"""
Auto-generated P0 scenario spec for: L5-2_v2
Event type: L5-2 — Fog Onset / Low Visibility
Category: environmental
CAAC ref: CAAC-4 related (visibility-induced obstacle strike)
SORA SAIL: III-IV
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L5-2_v2",
        category="environmental.l5-2",
        description="Sudden fog bank, immediate visibility loss",
        duration_ticks=900,
    )
