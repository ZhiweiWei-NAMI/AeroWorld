...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7074.899, 6334.049, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7062.0, 6360.0, 32],
                             'resolved_position_enu_m': [7062.0, 6360.0, 32],
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7074.899, 6334.049, 0.0],
                  'radius_m': 188.98,
...
SPEC_DATA = {'category': 'environment',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_weather_l5_2_v2',
               'initial_pos_enu': [7062.0, 6360.0, 32],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_fog_onset',
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_visual_nav_degraded',
                              ...
                              {'params': {'action_id': 'move_uav_fog_slow_hold',
                                          'entity_id': 'uav_weather_l5_2_v2',
                                          'velocity_mps': 2.5,
                                          'waypoints_enu_m': [[7062.0, 6360.0, 32], [7068.0, 6364.0, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_fog_abort',
                                          'entity_id': 'uav_weather_l5_2_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7068.0, 6364.0, 32], [7054.0, 6372.0, 34]]},
                               'type': 'move_entity'}],
