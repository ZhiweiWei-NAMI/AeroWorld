"""
Auto-generated P0 scenario spec for: L5-4_v1
Event type: L5-4 — Lighting Condition Change
Category: environmental
CAAC ref: CAAC-4 related (lighting-induced obstacle strike)
SORA SAIL: II
Severity: minor
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L5-4_v1",
        category="environmental.l5-4",
        description="Dusk transition, gradual sensor adaptation",
        duration_ticks=900,
    )
