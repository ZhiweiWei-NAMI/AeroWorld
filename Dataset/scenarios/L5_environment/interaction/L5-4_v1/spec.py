...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7154.318, 6445.765, 180.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7100.876, 6336.88, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_weather_l5_4_v1',
                             'mission_start_enu_m': [7086.0, 6370.5, 32],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7100.876, 6336.88, 3.0],
                             'resolved_position_enu_m': [7100.876, 6336.88, 3.0],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7086.0, 6370.5, 32]]},
              {'activation_tick': 0,
               'category': 'vehicle',
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7154.318, 6445.765, 0.0],
                  'radius_m': 1479.932,
...
SPEC_DATA = {'category': 'environment',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_weather_l5_4_v1',
               'initial_pos_enu': [7100.876, 6336.88, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7086.0, 6370.5, 32]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_weather_l5_4_v1_takeoff_entry',
                                          'entity_id': 'uav_weather_l5_4_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7100.876, 6336.88, 3.0],
                                                              [7100.876, 6336.88, 24.0],
                                                              [7086.0, 6370.5, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_infrared_mode',
                              ...
                              {'params': {'action_id': 'move_uav_ir_continue',
                                          'entity_id': 'uav_weather_l5_4_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7086.0, 6370.5, 32], [7098.0, 6378.5, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_weather_l5_4_v1_landing_return',
                                          'entity_id': 'uav_weather_l5_4_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7098.0, 6378.5, 32.0],
                                                              [7100.876, 6336.88, 22.0],
                                                              [7100.876, 6336.88, 3.0]]},
                               'type': 'move_entity'}],
