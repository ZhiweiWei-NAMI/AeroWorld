"""
Auto-generated P0 scenario spec for: L5-5_v1
Event type: L5-5 — Extreme Temperature Event
Category: environmental
CAAC ref: CAAC-8 related (battery/power failure due to temperature)
SORA SAIL: II
Severity: minor
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L5-5_v1",
        category="environmental.l5-5",
        description="High temperature, battery derating, shortened mission",
        duration_ticks=900,
    )
