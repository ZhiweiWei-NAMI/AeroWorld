...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [97.333, 173.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [94.0, 174.0, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
...
SPEC_DATA = {'category': 'environment',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_uav_battery_derating',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_shortened_range',
                                          'entity_id': 'uav_weather_l5_5_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[94.0, 174.0, 32], [102.0, 179.0, 32]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'high_temperature_process', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_uav_thermal_abort',
                                          'entity_id': 'uav_weather_l5_5_v1',
                                          'velocity_mps': 4.5,
                                          'waypoints_enu_m': [[102.0, 179.0, 32], [89.0, 183.0, 31]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'range_shortened', 'type': 'event_fired'}}],
