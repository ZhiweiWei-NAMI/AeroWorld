...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [72.75, 163.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [70.0, 163.5, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [71.0, 164.5, 28], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_crosswind',
                 ...
                 {'actions': [{'params': {'action_id': 'set_wind_gust',
                              ...
                              {'params': {'action_id': 'move_uav_wind_hold',
                                          'entity_id': 'uav_weather_l5_3_v1',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[70.0, 163.5, 32], [73.0, 168.5, 33]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_wind_recovery',
                                          'entity_id': 'uav_weather_l5_3_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[73.0, 168.5, 33], [62.0, 173.5, 34]]},
                               'type': 'move_entity'},
