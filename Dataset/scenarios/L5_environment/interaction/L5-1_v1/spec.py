...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [33.333, 145.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [30.0, 146.0, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
...
SPEC_DATA = {'category': 'environment',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_rain_moderate',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_rain_slowdown',
                                          'entity_id': 'uav_weather_l5_1_v1',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[30.0, 146.0, 32], [40.0, 154.0, 32]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_car_wet_slowdown',
                                          'entity_id': 'weather_car_l5_1_v1',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[38.0, 138.0, 0], [45.0, 139.0, 0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_rain_recover',
                                          'entity_id': 'uav_weather_l5_1_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[40.0, 154.0, 32], [24.0, 162.0, 34]]},
                               'type': 'move_entity'},
