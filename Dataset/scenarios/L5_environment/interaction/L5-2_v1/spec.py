...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7098.186, 6408.861, 180.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'category': 'vehicle',
               'entity_id': 'bg_vehicle_l5_2_v1_01',
               ...
               'placement_mode': 'lane_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7098.186, 6408.861, 0.0],
                  'radius_m': 1540.899,
 ...
 'spawn_sequencing': [{'entity_id': 'uav_weather_l5_2_v1', 'tick': 0},
                      ...
                      {'entity_id': 'bg_vehicle_l5_2_v1_01', 'tick': 0}],
 'validation_rules': [{'description': 'uav_weather_l5_2_v1 is declared before event_script references it in L5-2_v1',
                      ...
                      {'description': 'Background road vehicles must stay clear of overlays, logical regions, pads, '
                       ...
                       'entity_ids': ['bg_vehicle_l5_2_v1_01'],
                       'min_count': 1,
...
SPEC_DATA = {'category': 'environment',
 ...
 'parameters': {'allow_building_impact': False,
                'background_vehicle_policy': {'added_entity_ids': ['bg_vehicle_l5_2_v1_01'],
                                              'policy': 'road_context_non_event_actor_v1',
                                              'reason': 'weather road traffic context',
                                              'requested_count': 1},
                'target_uav_count': 1,
                'uav_altitude_layers_m': [30.0, 50.0, 80.0],
                'uav_assigned_altitudes_m': {'uav_weather_l5_2_v1': 50.0},
                ...
                'uav_corridor_segments': [{'assigned_altitude_m': 50.0,
                                           ...
                                           'point_count': 5,
                                           'used_lateral_bypass': True}],
                'uav_lateral_bypass_used': {'uav_weather_l5_2_v1': True},
