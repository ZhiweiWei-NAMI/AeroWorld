...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7056.445, 6327.373, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7046.0, 6353.0, 32],
                             'resolved_position_enu_m': [7046.0, 6353.0, 32],
...
SPEC_DATA = {'category': 'environment',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_weather_l5_1_v3',
               'initial_pos_enu': [7046.0, 6353.0, 32],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_rain_onset',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_rain_slowdown',
                                          'entity_id': 'uav_weather_l5_1_v3',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[7046.0, 6353.0, 32], [7056.0, 6361.0, 32]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'set_rain_heavy_visibility',
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'delay_ticks': 30, 'event_ref': 'rain_speed_reduction', 'type': 'event_fired_after'}},
                 {'actions': [{'params': {'action_id': 'move_uav_rain_recover',
                                          'entity_id': 'uav_weather_l5_1_v3',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7056.0, 6361.0, 32], [7040.0, 6369.0, 34]]},
                               'type': 'move_entity'},
