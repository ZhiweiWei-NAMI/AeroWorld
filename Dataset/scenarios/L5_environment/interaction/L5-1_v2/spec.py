...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7078.328, 6422.516, 180.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7008.199, 6363.229, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_weather_l5_1_v2',
                             'mission_start_enu_m': [7038.0, 6349.5, 32],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7008.199, 6363.229, 3.0],
                             'resolved_position_enu_m': [7008.199, 6363.229, 3.0],
                             'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7038.0, 6349.5, 32]]},
              {'activation_tick': 0,
               'category': 'vehicle',
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7078.328, 6422.516, 0.0],
                  'radius_m': 1540.236,
...
SPEC_DATA = {'category': 'environment',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_weather_l5_1_v2',
               'initial_pos_enu': [7008.199, 6363.229, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [[7038.0, 6349.5, 32]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_weather_l5_1_v2_takeoff_entry',
                                          'entity_id': 'uav_weather_l5_1_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7008.199, 6363.229, 3.0],
                                                              [7008.199, 6363.229, 24.0],
                                                              [7038.0, 6349.5, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_weather_l5_1_v2_landing_return',
                                          'entity_id': 'uav_weather_l5_1_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7032.0, 6365.5, 34.0],
                                                              [7008.199, 6363.229, 22.0],
                                                              [7008.199, 6363.229, 3.0]]},
                               'type': 'move_entity'}],
