...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7031.738, 6341.851, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7038.0, 6349.5, 32],
                             'resolved_position_enu_m': [7038.0, 6349.5, 32],
...
SPEC_DATA = {'category': 'environment',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_weather_l5_1_v2',
               'initial_pos_enu': [7038.0, 6349.5, 32],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_rain_onset',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_rain_slowdown',
                                          'entity_id': 'uav_weather_l5_1_v2',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[7038.0, 6349.5, 32], [7048.0, 6357.5, 32]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_rain_recover',
                                          'entity_id': 'uav_weather_l5_1_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7048.0, 6357.5, 32], [7032.0, 6365.5, 34]]},
                               'type': 'move_entity'},
