# L5-1_v2: physically animated semantic chain with weather-linked continuous interaction
...
## Chain
rain variant > degraded route

## Actors
Entities: semantic UAVs, semantic background vehicles/pedestrians, and weather-visible facilities/logical actors.
- Background vehicle semantics: cautious traffic
- Background pedestrian semantics: shelter/wait states
