...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7088.838, 6348.046, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7078.0, 6367.0, 32],
                             'resolved_position_enu_m': [7078.0, 6367.0, 32],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_122',
                             ...
                             'resolved_position_enu_m': [7098.54, 6330.005, 0.0],
                             'rotation_deg': {'yaw_deg': 24.258},
...
SPEC_DATA = {'category': 'environment',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_weather_l5_3_v2',
               'initial_pos_enu': [7078.0, 6367.0, 32],
              ...
              {'asset_id': 'pedestrian.cityops.basic.v1',
               'entity_id': 'weather_ped_l5_3_v2',
               'initial_pos_enu': [7098.54, 6330.005, 0.0],
               'initial_rotation_deg': [0.0, 0.0, 24.258],
               'movement_waypoints': [],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_wind_onset',
                 ...
                 {'actions': [{'params': {'action_id': 'set_wind_gust',
                              ...
                              {'params': {'action_id': 'move_uav_wind_hold',
                                          'entity_id': 'uav_weather_l5_3_v2',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[7078.0, 6367.0, 32], [7081.0, 6372.0, 33]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_wind_recovery',
                                          'entity_id': 'uav_weather_l5_3_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7081.0, 6372.0, 33], [7070.0, 6377.0, 34]]},
                               'type': 'move_entity'},
