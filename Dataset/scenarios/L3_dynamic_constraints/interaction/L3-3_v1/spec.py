...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7068.052, 6255.987, 75.0],
 ...
 'entities': [{'activation_tick': 240,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7064.0, 6244.0, 33],
                             'resolved_position_enu_m': [7064.0, 6244.0, 33],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7068.052, 6255.987, 0.0],
                  'radius_m': 189.809,
...
SPEC_DATA = {'category': 'dynamic_constraints',
 ...
 'entities': [{'asset_id': 'trigger.hazard.generic.box.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l3_3_v1',
               'initial_pos_enu': [7064.0, 6244.0, 33],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'spawn_hazmat_zone',
                 ...
                 {'actions': [{'params': {'action_id': 'move_ped_a_safe',
                                          'entity_id': 'ped_hazmat_l3_3_v1_a',
                                          'velocity_mps': 1.6,
                                          'waypoints_enu_m': [[7075.075, 6261.529, 0.0], [7067.73, 6275.323, 0.0]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_ambulance_hazmat',
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'delay_ticks': 108, 'event_ref': 'pedestrian_evacuation', 'type': 'event_fired_after'}},
