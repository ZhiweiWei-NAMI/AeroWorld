...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7052.755, 6249.158, 94.077],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7050.14, 6240.447, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l3_2_v1',
                             'mission_start_enu_m': [7038.0, 6237.0, 31],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7050.14, 6240.447, 3.0],
                             'resolved_position_enu_m': [7050.14, 6240.447, 3.0],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7038.0, 6237.0, 31], [7056.0, 6251.0, 31]]},
              {'activation_tick': 280,
              ...
              {'activation_tick': 0,
               'category': 'facility',
               'entity_id': 'pad_home_uav_l3_2_v1',
               'initial_state': {'mode': 'available'},
               'logical_asset_id': 'facility.landing_pad.visible.v1',
               'placement': {'approach_side': 'departure',
                             'pad_instance_id': 'home_uav_l3_2_v1',
                             'position_enu_m': [7050.14, 6240.447, 0.0],
                             'resolved_position_enu_m': [7050.14, 6240.447, 0.0],
                             'rotation_deg': {'yaw_deg': -74.688}},
               'placement_mode': 'pad_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7052.755, 6249.158, 0.0],
                  'radius_m': 193.846,
 ...
 'scenario_id': 'L3-2_v1',
 'spawn_sequencing': [{'entity_id': 'uav_l3_2_v1', 'tick': 0},
                      {'entity_id': 'temporary_nfz_l3_2_v1', 'tick': 280},
                      {'entity_id': 'pad_home_uav_l3_2_v1', 'tick': 0}],
...
SPEC_DATA = {'category': 'dynamic_constraints',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l3_2_v1',
               'initial_pos_enu': [7050.14, 6240.447, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7038.0, 6237.0, 31], [7056.0, 6251.0, 31]],
              ...
              {'asset_id': 'facility.landing_pad.visible.v1',
               'entity_id': 'pad_home_uav_l3_2_v1',
               'initial_pos_enu': [7050.14, 6240.447, 0.0],
               'initial_rotation_deg': [0.0, 0.0, -74.688],
               'movement_waypoints': [],
               'visual_state': {'mode': 'available'}}],
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l3_2_v1_takeoff_entry',
                                          'entity_id': 'uav_l3_2_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7050.14, 6240.447, 3.0],
                                                              [7050.14, 6240.447, 24.0],
                                                              [7038.0, 6237.0, 31]]},
                               'type': 'move_entity'}],
                  'event_id': 'lifecycle_takeoff_uav_l3_2_v1',
                  'log_category': 'uav_lifecycle',
                  'log_overlay': 'uav_lifecycle',
                  'log_severity': 'info',
                  'log_target_ids': ['uav_l3_2_v1', 'pad_home_uav_l3_2_v1'],
                  'log_title': 'UAV takes off from visible home pad and enters mission airspace',
                  'log_topic': 'evt_L3-2_v1_lifecycle_takeoff_uav_l3_2_v1',
                  'max_fire_count': 1,
                  'on_fire_emit': [],
                  'priority': 0,
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l3_2_v1_landing_return',
                                          'entity_id': 'uav_l3_2_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7072.0, 6277.0, 34.0],
                                                              [7050.14, 6240.447, 22.0],
                                                              [7050.14, 6240.447, 3.0]]},
                               'type': 'move_entity'}],
                  'event_id': 'lifecycle_landing_uav_l3_2_v1',
                  'log_category': 'uav_lifecycle',
                  'log_overlay': 'uav_lifecycle',
                  'log_severity': 'info',
                  'log_target_ids': ['uav_l3_2_v1', 'pad_home_uav_l3_2_v1'],
                  'log_title': 'UAV returns to the visible home pad and lands after mission resolution',
                  'log_topic': 'evt_L3-2_v1_lifecycle_landing_uav_l3_2_v1',
                  'max_fire_count': 1,
                  'on_fire_emit': [],
                  'priority': 9,
