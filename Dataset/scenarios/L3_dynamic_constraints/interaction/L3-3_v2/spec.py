...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [82.0, 61.6, 75.0],
 ...
 'entities': [{'activation_tick': 240,
               ...
               'placement': {'center_enu_m': [92.0, 70.0, 3], 'extent_m': [13, 10, 4]},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [76.0, 49.0, 33], 'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'dynamic_constraints',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'spawn_hazmat_zone',
                 ...
                 {'actions': [{'params': {'action_id': 'move_ped_a_safe',
                                          'entity_id': 'ped_hazmat_l3_3_v2_a',
                                          'velocity_mps': 1.6,
                                          'waypoints_enu_m': [[89.0, 67.0, 0], [78.0, 78.0, 0]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_ped_b_safe',
                                          'entity_id': 'ped_hazmat_l3_3_v2_b',
                                          'velocity_mps': 1.4,
                                          'waypoints_enu_m': [[95.0, 68.0, 0], [106.0, 79.0, 0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_ambulance_hazmat',
                                          'entity_id': 'ambulance_l3_3_v2',
                                          'velocity_mps': 11.0,
                                          'waypoints_enu_m': [[58.0, 54.0, 0], [80.0, 62.0, 0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_hazmat_orbit',
                                          'entity_id': 'uav_l3_3_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[76.0, 49.0, 33], [86.0, 59.0, 30], [102.0, 82.0, 30]]},
                               'type': 'move_entity'},
