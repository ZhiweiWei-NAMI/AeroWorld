...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [6894.535, 6682.194, 180.0],
 ...
 'entities': [{'activation_tick': 240,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7075.75, 6248.473, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l3_3_v2',
                             'mission_start_enu_m': [7076.0, 6249.0, 33],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7075.75, 6248.473, 3.0],
                             'resolved_position_enu_m': [7075.75, 6248.473, 3.0],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7076.0, 6249.0, 33]]},
              {'activation_tick': 0,
               'category': 'facility',
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [6894.535, 6682.194, 0.0],
                  'radius_m': 1473.911,
...
SPEC_DATA = {'category': 'dynamic_constraints',
 ...
 'entities': [{'asset_id': 'trigger.hazard.generic.box.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l3_3_v2',
               'initial_pos_enu': [7075.75, 6248.473, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7076.0, 6249.0, 33]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l3_3_v2_takeoff_entry',
                                          'entity_id': 'uav_l3_3_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7075.75, 6248.473, 3.0],
                                                              [7075.75, 6248.473, 24.0],
                                                              [7076.0, 6249.0, 33]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_hazmat_orbit',
                                          'entity_id': 'uav_l3_3_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7076.0, 6249.0, 33],
                                                              [7086.0, 6259.0, 30],
                                                              [7102.0, 6282.0, 30]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l3_3_v2_landing_return',
                                          'entity_id': 'uav_l3_3_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7102.0, 6282.0, 30.0],
                                                              [7075.75, 6248.473, 22.0],
                                                              [7075.75, 6248.473, 3.0]]},
                               'type': 'move_entity'}],
