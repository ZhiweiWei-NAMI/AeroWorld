"""
Auto-generated P0 scenario spec for: L3-1_v1
Event type: L3-1 — Road Construction Detour
Category: operational
CAAC ref: Non-emergency (temporary modification)
SORA SAIL: I
Severity: minor
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L3-1_v1",
        category="operational.l3-1",
        description="Partial lane closure with detour",
        duration_ticks=900,
    )
