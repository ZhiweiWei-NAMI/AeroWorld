"""
Auto-generated P0 scenario spec for: L3-2_v2
Event type: L3-2 — Temporary No-Fly Zone Activation
Category: violation
CAAC ref: CAAC-10 (entering restricted zones)
SORA SAIL: IV
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L3-2_v2",
        category="violation.l3-2",
        description="Immediate TFR, UAV must emergency land",
        duration_ticks=900,
    )
