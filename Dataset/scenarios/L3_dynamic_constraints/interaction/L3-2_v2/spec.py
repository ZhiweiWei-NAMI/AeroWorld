...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7062.0, 6250.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7050.0, 6242.0, 31],
                             'resolved_position_enu_m': [7050.0, 6242.0, 31],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7068.0, 6256.0, 31]]},
              {'activation_tick': 280,
 ...
 'local_bounds': {'center_enu_m': [7064.0, 6252.333, 0.0],
                  'radius_m': 177.401,
 ...
 'scenario_id': 'L3-2_v2',
 'spawn_sequencing': [{'entity_id': 'uav_l3_2_v2', 'tick': 0}, {'entity_id': 'temporary_nfz_l3_2_v2', 'tick': 280}],
...
SPEC_DATA = {'category': 'dynamic_constraints',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l3_2_v2',
               'initial_pos_enu': [7050.0, 6242.0, 31],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7068.0, 6256.0, 31]],
