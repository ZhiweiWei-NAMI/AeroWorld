...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7060.335, 6253.069, 99.196],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7049.616, 6242.363, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_l3_2_v2',
                             'mission_start_enu_m': [7050.0, 6242.0, 31],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7049.616, 6242.363, 3.0],
                             'resolved_position_enu_m': [7049.616, 6242.363, 3.0],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7050.0, 6242.0, 31], [7068.0, 6256.0, 31]]},
              {'activation_tick': 280,
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7060.335, 6253.069, 0.0],
                  'radius_m': 197.377,
...
SPEC_DATA = {'category': 'dynamic_constraints',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_l3_2_v2',
               'initial_pos_enu': [7049.616, 6242.363, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7050.0, 6242.0, 31], [7068.0, 6256.0, 31]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_l3_2_v2_takeoff_entry',
                                          'entity_id': 'uav_l3_2_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7049.616, 6242.363, 3.0],
                                                              [7049.616, 6242.363, 24.0],
                                                              [7050.0, 6242.0, 31]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_to_nfz_edge',
                                          'entity_id': 'uav_l3_2_v2',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7050.0, 6242.0, 31], [7068.0, 6256.0, 31]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_nfz_reroute',
                                          'entity_id': 'uav_l3_2_v2',
                                          'velocity_mps': 8.5,
                                          'waypoints_enu_m': [[7068.0, 6256.0, 31],
                                                              [7058.0, 6272.0, 34],
                                                              [7084.0, 6282.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_l3_2_v2_landing_return',
                                          'entity_id': 'uav_l3_2_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7084.0, 6282.0, 34.0],
                                                              [7049.616, 6242.363, 22.0],
                                                              [7049.616, 6242.363, 3.0]]},
                               'type': 'move_entity'}],
