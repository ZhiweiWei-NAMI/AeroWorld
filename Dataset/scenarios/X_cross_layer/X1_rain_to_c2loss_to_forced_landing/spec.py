...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7075.878, 6425.164, 180.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [6969.922, 6401.798, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_x1_forced_landing',
                             'mission_start_enu_m': [7042.0, 6444.0, 32],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [6969.922, 6401.798, 3.0],
                             'resolved_position_enu_m': [6969.922, 6401.798, 3.0],
                             'rotation_deg': {'yaw_deg': 30}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7042.0, 6444.0, 32]]},
              {'activation_tick': 0,
               'category': 'pedestrian',
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7075.878, 6425.164, 0.0],
                  'radius_m': 268.502,
...
SPEC_DATA = {'category': 'cross_layer',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_x1_forced_landing',
               'initial_pos_enu': [6969.922, 6401.798, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 30],
               'movement_waypoints': [[7042.0, 6444.0, 32]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_x1_forced_landing_takeoff_entry',
                                          'entity_id': 'uav_x1_forced_landing',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[6969.922, 6401.798, 3.0],
                                                              [6969.922, 6401.798, 24.0],
                                                              [7042.0, 6444.0, 32]]},
                               'type': 'move_entity'}],
