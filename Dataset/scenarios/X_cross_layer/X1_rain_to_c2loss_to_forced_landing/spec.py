...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7048.625, 6427.55, 165.073],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7048.625, 6427.55, 0.0],
                  'radius_m': 242.809,
...
SPEC_DATA = {'category': 'cross_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_x1_forced_landing_takeoff_entry',
                 ...
                 {'actions': [{'params': {'action_id': 'spawn_x1_crowd_initial',
                                          'count': 10,
                                          'group_id': 'crowd_x1',
                                          'seed': 1101,
                                          'spawn_box_extent_cm': [800, 500, 0],
                                          'spawn_origin_enu_m': [7125.889, 6432.461, 0.0]},
                               'type': 'spawn_crowd'}],
