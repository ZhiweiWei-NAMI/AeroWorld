...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7121.149, 6480.941, 93.27],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7124.368, 6512.721, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_x5_priority',
                             'mission_start_enu_m': [7088.0, 6484.0, 33],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7124.368, 6512.721, 3.0],
                             'resolved_position_enu_m': [7124.368, 6512.721, 3.0],
                             'rotation_deg': {'yaw_deg': 60}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7088.0, 6484.0, 33]]},
              {'activation_tick': 0,
               'category': 'uav',
               'entity_id': 'uav_x5_second',
               'initial_state': {'mode': 'preflight_on_pad'},
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7134.516, 6466.45, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_x5_second',
                             'mission_start_enu_m': [7124.0, 6460.0, 31],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.airsim.flying_pawn.v1',
               'placement': {'position_enu_m': [7134.516, 6466.45, 3.0],
                             'resolved_position_enu_m': [7134.516, 6466.45, 3.0],
                             'rotation_deg': {'yaw_deg': 280}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7124.0, 6460.0, 31]]},
              {'activation_tick': 0,
               'category': 'facility',
              ...
              {'activation_tick': 0,
               ...
               'placement_mode': 'pad_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7121.149, 6480.941, 0.0],
                  'radius_m': 193.29,
...
SPEC_DATA = {'category': 'cross_layer',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_x5_priority',
               'initial_pos_enu': [7124.368, 6512.721, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 60],
               'movement_waypoints': [[7088.0, 6484.0, 33]],
               'visual_state': {'mode': 'preflight_on_pad'}},
              {'asset_id': 'uav.airsim.flying_pawn.v1',
               'entity_id': 'uav_x5_second',
               'initial_pos_enu': [7134.516, 6466.45, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 280],
               'movement_waypoints': [[7124.0, 6460.0, 31]],
               'visual_state': {'mode': 'preflight_on_pad'}},
              {'asset_id': 'facility.landing_pad.visible.v1',
               'entity_id': 'pad_home_uav_x5_priority',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_x5_priority_takeoff_entry',
                                          'entity_id': 'uav_x5_priority',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7124.368, 6512.721, 3.0],
                                                              [7124.368, 6512.721, 24.0],
                                                              [7088.0, 6484.0, 33]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_x5_second_takeoff_entry',
                                          'entity_id': 'uav_x5_second',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7134.516, 6466.45, 3.0],
                                                              [7134.516, 6466.45, 24.0],
                                                              [7124.0, 6460.0, 31]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_x5_second_landing_return',
                                          'entity_id': 'uav_x5_second',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7140.0, 6496.0, 34.0],
                                                              [7134.516, 6466.45, 22.0],
