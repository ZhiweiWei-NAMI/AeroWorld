...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 ...
 'local_bounds': {'center_enu_m': [7111.265, 6431.571, 0.0],
                  'radius_m': 215.419,
...
SPEC_DATA = {'category': 'cross_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'play_x3_ped_fall',
                 ...
                 {'actions': [{'params': {'action_id': 'move_x3_ambulance_dispatch',
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'delay_ticks': 137, 'event_ref': 'uav_detection', 'type': 'event_fired_after'}},
                 {'actions': [{'params': {'action_id': 'spawn_x3_police_tape',
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'delay_ticks': 38, 'event_ref': 'ambulance_dispatch', 'type': 'event_fired_after'}},
