...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [64.0, 253.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_32', 'longitudinal_s': 50, 'offset_from_curb_m': 1.1},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [59.0, 250.0, 32], 'rotation_deg': {'yaw_deg': 60}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               'category': 'vehicle',
               ...
               'placement': {'edge_id': 'cg_edge_33', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 35},
              ...
              {'activation_tick': 420,
               ...
               'placement': {'position_enu_m': [77.0, 260.0, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'cross_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'play_x3_ped_fall',
                 ...
                 {'actions': [{'params': {'action_id': 'move_x3_uav_detect',
                                          'entity_id': 'uav_x3_detect',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[59.0, 250.0, 32], [76.0, 260.0, 16]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_x3_ambulance_dispatch',
                                          'entity_id': 'ambulance_x3',
                                          'velocity_mps': 12.0,
                                          'waypoints_enu_m': [[42.0, 243.0, 0], [71.0, 256.0, 0]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'uav_detection', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'spawn_x3_police_tape',
                                          'asset_id': 'prop.incident.police_tape.v1',
                                          'entity_id': 'police_tape_x3',
                                          'position_enu_m': [77.0, 260.0, 0],
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'ambulance_dispatch', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'capture_x3_response', 'camera_id': 'demo_high_overview'},
                  ...
                  'on_fire_emit': [],
                  'priority': 5,
                  'trigger': {'event_ref': 'isolation_setup', 'type': 'event_fired'}}],
