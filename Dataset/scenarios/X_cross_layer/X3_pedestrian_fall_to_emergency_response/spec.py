...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7066.168, 6427.182, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_785',
                             ...
                             'resolved_position_enu_m': [6977.193, 6406.004, 0.0],
                             'rotation_deg': {'yaw_deg': 120.045},
                             'source_edge_id_hint': 'cg_edge_33',
...
SPEC_DATA = {'category': 'cross_layer',
 ...
 'entities': [{'asset_id': 'pedestrian.cityops.basic.v1',
              ...
              {'asset_id': 'vehicle.emergency.ambulance.v1',
               'entity_id': 'ambulance_x3',
               'initial_pos_enu': [6977.193, 6406.004, 0.0],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'play_x3_ped_fall',
                 ...
                 {'actions': [{'params': {'action_id': 'move_x3_ambulance_dispatch',
                                          'entity_id': 'ambulance_x3',
                                          'velocity_mps': 12.0,
                                          'waypoints_enu_m': [[6977.193, 6406.004, 0.0], [7117.119, 6427.869, 0.0]]},
                               'type': 'move_entity'}],
