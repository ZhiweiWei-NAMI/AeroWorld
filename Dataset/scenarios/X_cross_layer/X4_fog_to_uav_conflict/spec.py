...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [91.0, 270.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [72.0, 265.0, 29], 'rotation_deg': {'yaw_deg': 70}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [110.0, 275.0, 31], 'rotation_deg': {'yaw_deg': 250}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'cross_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_x4_fog',
                 ...
                 {'actions': [{'params': {'action_id': 'set_x4_uav_a_visual_degraded',
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'fog_threshold', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_x4_uav_a_converge',
                                          'entity_id': 'uav_x4_a',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[72.0, 265.0, 29], [91.0, 270.0, 30]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_x4_uav_b_converge',
                                          'entity_id': 'uav_x4_b',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[110.0, 275.0, 31], [91.0, 270.0, 30]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'visibility_drop', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_x4_uav_a_hover',
                              ...
                              {'params': {'action_id': 'move_x4_uav_b_evasion',
                                          'entity_id': 'uav_x4_b',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[91.0, 270.0, 30], [104.0, 283.0, 36]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_x4_uav_a_resume',
                                          'entity_id': 'uav_x4_a',
                                          'velocity_mps': 5.5,
                                          'waypoints_enu_m': [[91.0, 270.0, 30], [74.0, 283.0, 30]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 5,
                  'trigger': {'event_ref': 'fog_uav_conflict', 'type': 'event_fired'}}],
