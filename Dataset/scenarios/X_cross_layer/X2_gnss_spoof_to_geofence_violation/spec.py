...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [73.5, 258.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [58.0, 251.0, 32], 'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'center_enu_m': [89.0, 265.0, 28], 'extent_m': [12, 10, 15]},
...
SPEC_DATA = {'category': 'cross_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_x2_spoof_flag',
                 ...
                 {'actions': [{'params': {'action_id': 'move_x2_corrected_route',
                                          'entity_id': 'uav_x2_spoofed',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[86.0, 263.0, 32], [66.0, 275.0, 34]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'geofence_violation', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_x2_nav_restored',
                  ...
                  'on_fire_emit': [],
                  'priority': 5,
                  'trigger': {'event_ref': 'safety_correction', 'type': 'event_fired'}}],
