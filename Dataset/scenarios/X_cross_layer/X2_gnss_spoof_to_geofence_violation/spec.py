...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7086.404, 6446.255, 96.113],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             ...
                             'mission_start_enu_m': [7058.0, 6451.0, 32],
               ...
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7058.0, 6451.0, 32]]},
              {'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7086.404, 6446.255, 0.0],
                  'radius_m': 195.25,
...
SPEC_DATA = {'category': 'cross_layer',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               ...
               'movement_waypoints': [[7058.0, 6451.0, 32]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_x2_spoofed_takeoff_entry',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_x2_spoofed_landing_return',
                                          'entity_id': 'uav_x2_spoofed',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7066.0, 6475.0, 34.0],
