"""
Auto-generated P0 scenario spec for: L6-4_v2
Event type: L6-4 — Communication Jamming
Category: failure
CAAC ref: Non-emergency (communication interference)
SORA SAIL: V
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L6-4_v2",
        category="failure.l6-4",
        description="Wideband jamming, all UAVs in area affected",
        duration_ticks=900,
    )
