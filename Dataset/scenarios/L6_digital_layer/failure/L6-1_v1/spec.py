...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [38.0, 198.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [42.0, 200.0, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [34.0, 196.0, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'digital_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_tower_c2_loss',
                              ...
                              {'params': {'action_id': 'move_uav_until_c2_loss',
                                          'entity_id': 'uav_digital_l6_1_v1',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[34.0, 196.0, 32], [48.0, 204.0, 31]]},
                               'type': 'move_entity'}],
                  'event_id': 'c2_loss',
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_rth',
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'c2_loss', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_tower_link_restored',
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'rth_engaged', 'type': 'event_fired'}}],
