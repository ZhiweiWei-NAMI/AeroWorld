...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [70.0, 210.8, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [74.0, 212.8, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [66.0, 208.8, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
 ...
 'scenario_id': 'L6-3_v1',
 'spawn_sequencing': [{'entity_id': 'tower_l6_3_v1', 'tick': 0}, {'entity_id': 'uav_digital_l6_3_v1', 'tick': 0}],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_gnss_spoofing_detected',
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_nav_lock',
                              ...
                              {'params': {'action_id': 'move_uav_spoof_corrected',
                                          'entity_id': 'uav_digital_l6_3_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[93.0, 226.8, 31], [74.0, 230.8, 32]]},
                               'type': 'move_entity'},
