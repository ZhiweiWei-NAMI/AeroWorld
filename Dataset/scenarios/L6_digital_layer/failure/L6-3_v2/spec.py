...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7078.0, 6414.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7074.0, 6412.0, 32],
                             'resolved_position_enu_m': [7074.0, 6412.0, 32],
 ...
 'scenario_id': 'L6-3_v2',
 'spawn_sequencing': [{'entity_id': 'tower_l6_3_v2', 'tick': 0}, {'entity_id': 'uav_digital_l6_3_v2', 'tick': 0}],
...
SPEC_DATA = {'category': 'digital_layer',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_digital_l6_3_v2',
               'initial_pos_enu': [7074.0, 6412.0, 32],
               'initial_rotation_deg': [0.0, 0.0, 35],
               'movement_waypoints': [],
               'visual_state': {'mode': 'patrol'}}],
 'event_chain': [{'actions': [{'params': {'action_id': 'set_gnss_spoofing_detected',
                                          'entity_id': 'tower_l6_3_v2',
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_nav_lock',
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'delay_ticks': 30, 'event_ref': 'spoofed_route_offset', 'type': 'event_fired_after'}},
                 {'actions': [{'params': {'action_id': 'set_tower_gnss_normal',
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'delay_ticks': 30, 'event_ref': 'safety_route_lock', 'type': 'event_fired_after'}}],
