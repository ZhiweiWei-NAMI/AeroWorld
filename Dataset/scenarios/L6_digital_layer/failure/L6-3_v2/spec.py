...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7094.271, 6422.922, 78.388],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             ...
                             'mission_start_enu_m': [7074.0, 6412.0, 32],
               ...
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7074.0, 6412.0, 32]]},
              {'activation_tick': 0,
               'category': 'facility',
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7094.271, 6422.922, 0.0],
                  'radius_m': 183.026,
...
SPEC_DATA = {'category': 'digital_layer',
 ...
 'entities': [{'asset_id': 'facility.radio.base_tower.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               ...
               'movement_waypoints': [[7074.0, 6412.0, 32]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_digital_l6_3_v2_takeoff_entry',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_spoofed_offset',
                                          'entity_id': 'uav_digital_l6_3_v2',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[7074.0, 6412.0, 32],
                                                              [7086.0, 6420.0, 31],
                                                              [7101.0, 6430.0, 31]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_nav_lock',
                              ...
                              {'params': {'action_id': 'move_uav_spoof_corrected',
                                          'entity_id': 'uav_digital_l6_3_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7101.0, 6430.0, 31], [7082.0, 6434.0, 32]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_digital_l6_3_v2_landing_return',
                                          'entity_id': 'uav_digital_l6_3_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7082.0, 6434.0, 32.0],
