...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [78.0, 214.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [82.0, 216.0, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [74.0, 212.0, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'digital_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_gnss_spoofing_detected',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_spoofed_offset',
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'spoofing_start', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_uav_nav_lock',
                              ...
                              {'params': {'action_id': 'move_uav_spoof_corrected',
                                          'entity_id': 'uav_digital_l6_3_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[101.0, 230.0, 31], [82.0, 234.0, 32]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'spoofed_route_offset', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_tower_gnss_normal',
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'safety_route_lock', 'type': 'event_fired'}}],
