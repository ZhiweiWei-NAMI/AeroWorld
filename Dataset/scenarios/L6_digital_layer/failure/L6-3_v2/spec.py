"""
Auto-generated P0 scenario spec for: L6-3_v2
Event type: L6-3 — GNSS Spoofing Attack
Category: failure
CAAC ref: CAAC-8 related (navigation system failure due to external attack)
SORA SAIL: V-VI
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L6-3_v2",
        category="failure.l6-3",
        description="Aggressive hijack, rapid trajectory change",
        duration_ticks=900,
    )
