...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [62.0, 207.6, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [66.0, 209.6, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [58.0, 205.6, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'digital_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_tower_c2_degraded',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_delayed_slowdown',
                                          'entity_id': 'uav_digital_l6_2_v2',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[58.0, 205.6, 32], [70.0, 211.6, 31]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'c2_degradation', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_tower_backup_lock',
                              ...
                              {'params': {'action_id': 'move_uav_backup_resume',
                                          'entity_id': 'uav_digital_l6_2_v2',
                                          'velocity_mps': 5.5,
                                          'waypoints_enu_m': [[70.0, 211.6, 31], [60.0, 223.6, 32]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'uav_delayed_response', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_tower_nominal',
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'backup_link_lock', 'type': 'event_fired'}}],
