...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [80.667, 218.867, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [90.0, 219.2, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [82.0, 215.2, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               'category': 'uav',
               ...
               'placement': {'position_enu_m': [70.0, 222.2, 34], 'rotation_deg': {'yaw_deg': 50}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'digital_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_tower_jamming',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_a_jam_hold',
                                          'entity_id': 'uav_digital_l6_4_v1',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[82.0, 215.2, 32], [86.0, 219.2, 35]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_uav_b_jam_hold',
                                          'entity_id': 'uav_digital_l6_4_v1_secondary',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[70.0, 222.2, 34], [75.0, 227.2, 36]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'set_tower_alternate_channel',
                              ...
                              {'params': {'action_id': 'move_uav_a_channel_recover',
                                          'entity_id': 'uav_digital_l6_4_v1',
                                          'velocity_mps': 5.5,
                                          'waypoints_enu_m': [[86.0, 219.2, 35], [97.0, 227.2, 33]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_uav_b_channel_recover',
                                          'entity_id': 'uav_digital_l6_4_v1_secondary',
                                          'velocity_mps': 5.5,
                                          'waypoints_enu_m': [[75.0, 227.2, 36], [64.0, 233.2, 34]]},
                               'type': 'move_entity'}],
