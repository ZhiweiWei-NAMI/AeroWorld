...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7080.667, 6418.867, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7082.0, 6415.2, 32],
                             'resolved_position_enu_m': [7082.0, 6415.2, 32],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7070.0, 6422.2, 34],
                             'resolved_position_enu_m': [7070.0, 6422.2, 34],
                             'rotation_deg': {'yaw_deg': 50}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7080.667, 6418.867, 0.0],
                  'radius_m': 171.175,
...
SPEC_DATA = {'category': 'digital_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_tower_jamming',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_a_jam_hold',
                                          'entity_id': 'uav_digital_l6_4_v1',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[7082.0, 6415.2, 32], [7086.0, 6419.2, 35]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_uav_b_jam_hold',
                                          'entity_id': 'uav_digital_l6_4_v1_secondary',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[7070.0, 6422.2, 34], [7075.0, 6427.2, 36]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'set_tower_alternate_channel',
                              ...
                              {'params': {'action_id': 'move_uav_a_channel_recover',
                                          'entity_id': 'uav_digital_l6_4_v1',
                                          'velocity_mps': 5.5,
                                          'waypoints_enu_m': [[7086.0, 6419.2, 35], [7097.0, 6427.2, 33]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_uav_b_channel_recover',
                                          'entity_id': 'uav_digital_l6_4_v1_secondary',
                                          'velocity_mps': 5.5,
                                          'waypoints_enu_m': [[7075.0, 6427.2, 36], [7064.0, 6433.2, 34]]},
                               'type': 'move_entity'}],
