...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [102.333, 221.267, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [106.0, 225.6, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [98.0, 221.6, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [103.0, 216.6, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'digital_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_gcs_intrusion',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_intrusion_abnormal',
                                          'entity_id': 'uav_digital_l6_5_v1',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[98.0, 221.6, 32], [118.0, 209.6, 32]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'set_gcs_locked',
                              ...
                              {'params': {'action_id': 'move_uav_command_lock',
                                          'entity_id': 'uav_digital_l6_5_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[118.0, 209.6, 32], [101.0, 228.6, 34]]},
                               'type': 'move_entity'}],
