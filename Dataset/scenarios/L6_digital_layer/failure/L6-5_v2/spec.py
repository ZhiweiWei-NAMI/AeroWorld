...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [110.333, 224.467, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [114.0, 228.8, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [106.0, 224.8, 32], 'rotation_deg': {'yaw_deg': 35}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [111.0, 219.8, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'digital_layer',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_gcs_intrusion',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_intrusion_abnormal',
                                          'entity_id': 'uav_digital_l6_5_v2',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[106.0, 224.8, 32], [126.0, 212.8, 32]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'gcs_intrusion', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_gcs_locked',
                              ...
                              {'params': {'action_id': 'move_uav_command_lock',
                                          'entity_id': 'uav_digital_l6_5_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[126.0, 212.8, 32], [109.0, 231.8, 34]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'abnormal_uav_behavior', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_gcs_secure',
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'command_lockout', 'type': 'event_fired'}}],
