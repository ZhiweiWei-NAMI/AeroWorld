# L6-5_v2: physically animated semantic chain with digital-fault continuous interaction
...
## Chain
intrusion variant > secure recovery

## Actors
Entities: semantic UAVs, semantic background vehicles/pedestrians, and digital/facility actors that remain visibly active.
- Background vehicle semantics: steady context
- Background pedestrian semantics: facility pedestrians
