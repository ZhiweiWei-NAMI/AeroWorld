...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7472.606, 7321.249, 97.893],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'category': 'vehicle',
               'entity_id': 'bg_vehicle_l4_7_v2_01',
               ...
               'placement_mode': 'lane_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7472.606, 7321.249, 0.0],
                  'radius_m': 196.478,
 ...
 'spawn_sequencing': [{'entity_id': 'ped_fall_l4_7_v2', 'tick': 0},
                      ...
                      {'entity_id': 'bg_vehicle_l4_7_v2_01', 'tick': 0}],
 'validation_rules': [{'description': 'ped_fall_l4_7_v2 is declared before event_script references it in L4-7_v2',
                      ...
                      {'description': 'Background road vehicles must stay clear of overlays, logical regions, pads, '
                       ...
                       'entity_ids': ['bg_vehicle_l4_7_v2_01'],
                       'min_count': 1,
...
SPEC_DATA = {'category': 'agents',
 ...
 'parameters': {'allow_building_impact': False,
                'background_vehicle_policy': {'added_entity_ids': ['bg_vehicle_l4_7_v2_01'],
                                              'policy': 'road_context_non_event_actor_v1',
                                              'reason': 'emergency response background traffic',
                                              'requested_count': 1},
                'incident_tick': 260,
                ...
                'uav_assigned_altitudes_m': {'uav_detect_l4_7_v2': 30.0},
                ...
                'uav_corridor_segments': [{'assigned_altitude_m': 30.0,
                                           ...
                                           'point_count': 4,
                                           'used_lateral_bypass': True}],
                'uav_lateral_bypass_used': {'uav_detect_l4_7_v2': True}},
 'scenario_id': 'L4-7_v2'}
