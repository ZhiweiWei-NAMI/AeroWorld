"""
Auto-generated P0 scenario spec for: L4-7_v2
Event type: L4-7 — Pedestrian Fall / Medical Emergency
Category: operational
CAAC ref: CAAC-14 related (serious injury)
SORA SAIL: I
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L4-7_v2",
        category="operational.l4-7",
        description="Sudden cardiac event, passerby alerts, UAV confirms",
        duration_ticks=900,
    )
