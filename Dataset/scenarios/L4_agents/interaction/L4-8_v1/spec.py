...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [122.5, 126.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [112.0, 120.0, 34], 'rotation_deg': {'yaw_deg': 50}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [133.0, 133.0, 0], 'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'spawn_incident_crowd',
                                          ...
                                          'spawn_origin_enu_m': [133.0, 133.0, 0]},
                               'type': 'spawn_crowd'}],
                 ...
                 {'actions': [{'params': {'action_id': 'clear_incident_crowd_for_evacuation',
                              ...
                              {'params': {'action_id': 'spawn_crowd_at_safe_zone',
                                          ...
                                          'spawn_origin_enu_m': [154.0, 149.0, 0]},
                               'type': 'spawn_crowd'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'crowd_generated', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_uav_monitor_evacuation',
                                          'entity_id': 'uav_crowd_monitor_l4_8_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[112.0, 120.0, 34],
                                                              [138.0, 138.0, 30],
                                                              [154.0, 149.0, 30]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'evacuation_triggered', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'clear_safe_crowd', 'group_id': 'crowd_safe_l4_8_v1'},
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'uav_evacuation_monitor', 'type': 'event_fired'}}],
