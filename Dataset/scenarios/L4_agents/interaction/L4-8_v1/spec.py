"""
Auto-generated P0 scenario spec for: L4-8_v1
Event type: L4-8 — Crowd Gathering / Evacuation
Category: operational
CAAC ref: Non-emergency (public safety)
SORA SAIL: I-II
Severity: minor
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L4-8_v1",
        category="operational.l4-8",
        description="Crowd gathering at metro exit, UAV monitors",
        duration_ticks=900,
    )
