...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7122.486, 6326.854, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7112.0, 6320.0, 34],
                             'resolved_position_enu_m': [7112.0, 6320.0, 34],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7132.972, 6333.707, 0.0],
                             'resolved_position_enu_m': [7132.972, 6333.707, 0.0],
                             'rotation_deg': {'yaw_deg': 0}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7122.486, 6326.854, 0.0],
                  'radius_m': 172.527,
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'spawn_incident_crowd',
                 ...
                 {'actions': [{'params': {'action_id': 'clear_incident_crowd_for_evacuation',
                              ...
                              {'params': {'action_id': 'spawn_crowd_at_safe_zone',
                                          'count': 12,
                                          'group_id': 'crowd_safe_l4_8_v1',
                                          'seed': 916,
                                          'spawn_box_extent_cm': [1000, 500, 0],
                                          'spawn_origin_enu_m': [7156.056, 6343.853, 0.0]},
                               'type': 'spawn_crowd'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_monitor_evacuation',
                                          ...
                                          'waypoints_enu_m': [[7112.0, 6320.0, 34],
                                                              [7132.972, 6333.707, 30],
                                                              [7156.056, 6343.853, 30]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'clear_safe_crowd', 'group_id': 'crowd_safe_l4_8_v1'},
                               'type': 'clear_crowd'}],
                  ...
                  'log_topic': 'evt_L4-8_v1_crowd_clear',
                  'max_fire_count': 1,
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'delay_ticks': 112,
