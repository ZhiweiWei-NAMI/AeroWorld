"""
Auto-generated P0 scenario spec for: L4-10_v2
Event type: L4-10 — Emergency Vehicle Priority Passage
Category: operational
CAAC ref: Non-emergency (emergency vehicle operations)
SORA SAIL: II
Severity: major
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        ...
        category="operational.l4-10",
        description="Fire truck wrong-way through blocked intersection",
        duration_ticks=900,
    )
