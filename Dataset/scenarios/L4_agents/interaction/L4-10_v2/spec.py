...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [142.167, 147.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_27', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 42},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_27', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 58},
               'placement_mode': 'lane_anchor',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               'category': 'uav',
               ...
               'placement': {'position_enu_m': [145.5, 157.0, 32], 'rotation_deg': {'yaw_deg': 60}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_ambulance_lights_on',
                 ...
                 {'actions': [{'params': {'action_id': 'move_civilian_yield',
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'ambulance_priority_approach', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_uav_priority_monitor',
                                          'entity_id': 'uav_priority_monitor_l4_10_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[145.5, 157.0, 32], [163.5, 155.0, 28]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'civilian_vehicle_yields', 'type': 'event_fired'}}],
