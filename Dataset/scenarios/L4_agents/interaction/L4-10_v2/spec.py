...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7148.541, 6351.788, 77.421],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7145.463, 6356.871, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_priority_monitor_l4_10_v2',
                             'mission_start_enu_m': [7145.5, 6357.0, 32],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7145.463, 6356.871, 3.0],
                             'resolved_position_enu_m': [7145.463, 6356.871, 3.0],
                             'rotation_deg': {'yaw_deg': 60}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7145.5, 6357.0, 32]]},
              {'activation_tick': 0,
               'category': 'facility',
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7148.541, 6351.788, 0.0],
                  'radius_m': 182.359,
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'vehicle.emergency.ambulance.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_priority_monitor_l4_10_v2',
               'initial_pos_enu': [7145.463, 6356.871, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 60],
               'movement_waypoints': [[7145.5, 6357.0, 32]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_priority_monitor_l4_10_v2_takeoff_entry',
                                          'entity_id': 'uav_priority_monitor_l4_10_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7145.463, 6356.871, 3.0],
                                                              [7145.463, 6356.871, 24.0],
                                                              [7145.5, 6357.0, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_priority_monitor_l4_10_v2_landing_return',
                                          'entity_id': 'uav_priority_monitor_l4_10_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7163.5, 6355.0, 28.0],
                                                              [7145.463, 6356.871, 22.0],
                                                              [7145.463, 6356.871, 3.0]]},
                               'type': 'move_entity'}],
