...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7469.69, 7320.328, 101.591],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7468.384, 7321.351, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_detect_l4_7_v1',
                             'mission_start_enu_m': [7443.588, 7310.766, 31],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7468.384, 7321.351, 3.0],
                             'resolved_position_enu_m': [7468.384, 7321.351, 3.0],
                             'rotation_deg': {'yaw_deg': 55}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7443.588, 7310.766, 31]]},
              {'activation_tick': 0,
               'category': 'vehicle',
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7469.69, 7320.328, 0.0],
                  'radius_m': 199.029,
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'pedestrian.cityops.basic.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_detect_l4_7_v1',
               'initial_pos_enu': [7468.384, 7321.351, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 55],
               'movement_waypoints': [[7443.588, 7310.766, 31]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_detect_l4_7_v1_takeoff_entry',
                                          'entity_id': 'uav_detect_l4_7_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7468.384, 7321.351, 3.0],
                                                              [7468.384, 7321.351, 24.0],
                                                              [7443.588, 7310.766, 31]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_detect_fall',
                                          'entity_id': 'uav_detect_l4_7_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7443.588, 7310.766, 31], [7471.588, 7330.766, 16]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_ambulance_to_fall',
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'delay_ticks': 83, 'event_ref': 'uav_detects_fall', 'type': 'event_fired_after'}},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_detect_l4_7_v1_landing_return',
                                          'entity_id': 'uav_detect_l4_7_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7471.588, 7330.766, 16.0],
                                                              [7468.384, 7321.351, 16.0],
                                                              [7468.384, 7321.351, 3.0]]},
                               'type': 'move_entity'}],
