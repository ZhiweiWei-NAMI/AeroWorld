...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7105.877, 6312.688, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_204',
                             ...
                             'resolved_position_enu_m': [7124.541, 6319.751, 0.0],
                             'rotation_deg': {'yaw_deg': 20.764},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7105.0, 6316.0, 31],
                             'resolved_position_enu_m': [7105.0, 6316.0, 31],
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'play_pedestrian_fall',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_detect_fall',
                                          'entity_id': 'uav_detect_l4_7_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7105.0, 6316.0, 31], [7124.541, 6319.751, 16]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_ambulance_to_fall',
                                          'entity_id': 'ambulance_fall_l4_7_v1',
                                          'velocity_mps': 12.0,
                                          'waypoints_enu_m': [[7088.089, 6302.314, 0.0], [7125.64, 6316.852, 0.0]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'delay_ticks': 55, 'event_ref': 'uav_detects_fall', 'type': 'event_fired_after'}},
                 {'actions': [{'params': {'action_id': 'capture_fall_response', 'camera_id': 'demo_high_overview'},
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'delay_ticks': 37, 'event_ref': 'ambulance_response', 'type': 'event_fired_after'}}],
