...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [104.667, 116.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_23', 'longitudinal_s': 42, 'offset_from_curb_m': 1.0},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [105.0, 116.0, 31], 'rotation_deg': {'yaw_deg': 55}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               'category': 'vehicle',
               ...
               'placement': {'edge_id': 'cg_edge_24', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 30},
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'play_pedestrian_fall',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_detect_fall',
                                          'entity_id': 'uav_detect_l4_7_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[105.0, 116.0, 31], [120.0, 125.0, 16]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'pedestrian_fall', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_ambulance_to_fall',
                                          'entity_id': 'ambulance_fall_l4_7_v1',
                                          'velocity_mps': 12.0,
                                          'waypoints_enu_m': [[87.0, 106.0, 0], [115.0, 122.0, 0]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'uav_detects_fall', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'capture_fall_response', 'camera_id': 'demo_high_overview'},
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'ambulance_response', 'type': 'event_fired'}}],
