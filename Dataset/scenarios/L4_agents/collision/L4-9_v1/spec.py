...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [130.0, 148.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_25', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 65},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_26', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 40},
               'placement_mode': 'lane_anchor',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'vehicle.ground.boxcar.v1',
               'entity_id': 'car_intersection_l4_9_v1_a',
               'initial_pos_enu': [117.0, 136.0, 0],
               'initial_rotation_deg': [0.0, 0.0, 80],
               'movement_waypoints': [],
               'visual_state': {'mode': 'moving'}},
              {'asset_id': 'vehicle.emergency.suv.v1',
               'entity_id': 'car_intersection_l4_9_v1_b',
               'initial_pos_enu': [143.0, 160.0, 0],
               'initial_rotation_deg': [0.0, 0.0, 185],
               'movement_waypoints': [],
               'visual_state': {'mode': 'moving'}}],
 'event_chain': [{'actions': [{'params': {'action_id': 'move_car_a_intersection',
                                          'entity_id': 'car_intersection_l4_9_v1_a',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[117.0, 136.0, 0],
                                                              [134.0, 137.0, 0],
                                                              [141.0, 138.0, 0]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_car_a_brake',
                                          'entity_id': 'car_intersection_l4_9_v1_a',
                                          'velocity_mps': 0.5,
                                          'waypoints_enu_m': [[141.0, 138.0, 0], [140.0, 138.0, 0]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_car_b_brake',
                                          'entity_id': 'car_intersection_l4_9_v1_b',
                                          'velocity_mps': 0.5,
                                          'waypoints_enu_m': [[141.0, 138.0, 0], [142.0, 139.0, 0]]},
                               'type': 'move_entity'},
