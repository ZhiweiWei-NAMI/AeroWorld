...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7073.377, 6300.983, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7061.901, 6299.072, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_falls_vehicle_l4_4_v1',
                             'mission_start_enu_m': [7062.5, 6298.0, 20],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7061.901, 6299.072, 3.0],
                             'resolved_position_enu_m': [7061.901, 6299.072, 3.0],
                             'rotation_deg': {'yaw_deg': 70}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7062.5, 6298.0, 20]]},
              {'activation_tick': 0,
               'category': 'vehicle',
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7073.377, 6300.983, 0.0],
                  'radius_m': 172.202,
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_falls_vehicle_l4_4_v1',
               'initial_pos_enu': [7061.901, 6299.072, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 70],
               'movement_waypoints': [[7062.5, 6298.0, 20]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_falls_vehicle_l4_4_v1_takeoff_entry',
                                          'entity_id': 'uav_falls_vehicle_l4_4_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7061.901, 6299.072, 3.0],
                                                              [7061.901, 6299.072, 18.0],
                                                              [7062.5, 6298.0, 20]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_falling_cross',
                                          'entity_id': 'uav_falls_vehicle_l4_4_v1',
                                          'velocity_mps': 5.5,
                                          'waypoints_enu_m': [[7062.5, 6298.0, 20],
                                                              [7073.5, 6302.0, 12],
                                                              [7082.5, 6305.0, 2.6]]},
                               'type': 'move_entity'},
