"""
Auto-generated P0 scenario spec for: L4-4_v1
Event type: L4-4 — UAV-Ground Vehicle Collision
Category: collision
CAAC ref: CAAC-13 (collision with vehicles)
SORA SAIL: V-VI
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L4-4_v1",
        category="collision.l4-4",
        description="Low-altitude UAV strikes moving vehicle",
        duration_ticks=900,
    )
