...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [73.5, 91.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [62.5, 98.0, 20], 'rotation_deg': {'yaw_deg': 70}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_20', 'lane_index': 0, 'lateral_offset_m': 0, 'longitudinal_s': 46},
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_falling_cross',
                              ...
                              {'params': {'action_id': 'move_car_crossing_path',
                                          'entity_id': 'car_under_uav_l4_4_v1',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[84.5, 85.0, 0], [83.5, 96.0, 0], [82.5, 105.0, 0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_vehicle_emergency_brake',
                                          'entity_id': 'car_under_uav_l4_4_v1',
                                          'velocity_mps': 0.5,
                                          'waypoints_enu_m': [[82.5, 105.0, 0], [83.0, 105.5, 0]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_uav_debris_ground',
                                          'entity_id': 'uav_falls_vehicle_l4_4_v1',
                                          'velocity_mps': 1.0,
                                          'waypoints_enu_m': [[82.5, 105.0, 2.6], [84.5, 106.0, 0.4]]},
                               'type': 'move_entity'},
