# L4-4_v1: physically animated semantic chain with a clear key event and continuous interaction
...
## Chain
UAV-vehicle crossing > brake

## Actors
Entities: semantic UAVs, background vehicles/pedestrians where present, and scenario-specific facilities/logical actors.
- Background vehicle semantics: brake/yield/contact-risk traffic
- Background pedestrian semantics: roadside witnesses
