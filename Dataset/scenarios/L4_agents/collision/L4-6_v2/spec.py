...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [119.5, 120.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'crosswalk_id': 'crosswalk_l4_6_v2', 'side': 'west'},
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_ped_from_crosswalk_to_lane',
                                          'entity_id': 'ped_jaywalk_l4_6_v2',
                                          'velocity_mps': 1.6,
                                          'waypoints_enu_m': [[105.5, 123.0, 0], [115.5, 122.0, 0]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_car_toward_crosswalk',
                                          'entity_id': 'car_jaywalk_l4_6_v2',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[133.5, 117.0, 0], [119.5, 121.0, 0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_car_hard_brake_ped',
                                          'entity_id': 'car_jaywalk_l4_6_v2',
                                          'velocity_mps': 0.8,
                                          'waypoints_enu_m': [[119.5, 121.0, 0], [118.0, 121.5, 0]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_ped_retreat_sidewalk',
                                          'entity_id': 'ped_jaywalk_l4_6_v2',
                                          'velocity_mps': 1.8,
                                          'waypoints_enu_m': [[115.5, 122.0, 0], [103.5, 126.0, 0]]},
                               'type': 'move_entity'}],
