...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7097.814, 6327.294, 96.135],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               'category': 'uav',
               'entity_id': 'uav_observer_l4_6_v2_1',
               ...
               'lifecycle': {'assigned_altitude_m': 30.0,
                             ...
                             'home_hover_enu_m': [7067.631, 6323.523, 30.0],
                             'home_pad_entity_id': 'pad_home_uav_observer_l4_6_v2_1',
                             'mission_start_enu_m': [7067.631, 6323.523, 30.0],
               ...
               'placement': {'position_enu_m': [7067.631, 6323.523, 30.0],
                             'resolved_position_enu_m': [7067.631, 6323.523, 30.0],
                             'rotation_deg': {'yaw_deg': 23.883}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7070.201, 6315.526, 30.0], [7067.631, 6323.523, 30.0]],
              ...
              {'activation_tick': 0,
               'category': 'facility',
               'entity_id': 'pad_home_uav_observer_l4_6_v2_1',
               'initial_state': {'mode': 'available'},
               'logical_asset_id': 'facility.landing_pad.visible.v1',
               'placement': {'approach_side': 'departure',
                             'pad_instance_id': 'home_uav_observer_l4_6_v2_1',
                             'position_enu_m': [7067.631, 6323.523, 0.0],
                             'resolved_position_enu_m': [7067.631, 6323.523, 0.0],
              ...
              {'activation_tick': 0,
               ...
               'enabled': True,
               'entity_id': 'corridor_l4_6_v2_uav_observer_l4_6_v2_1_00',
               ...
               'placement': {'altitude_layer_m': 30.0,
                             'center_enu_m': [7068.916, 6319.524, 30.0],
                             'extent_m': [4.2, 4.0, 4.0],
                             'resolved_position_enu_m': [7068.916, 6319.524, 30.0],
                             'rotation_deg': {'pitch_deg': 0.0, 'roll_deg': 0.0, 'yaw_deg': -72.184},
                             'scale_xyz': [8.4, 8.0, 8.0],
                             'segment_end_enu_m': [7070.201, 6315.526, 30.0],
                             'segment_start_enu_m': [7067.631, 6323.523, 30.0],
                             'size_m': [8.4, 8.0, 8.0],
                             'source_uav_entity_id': 'uav_observer_l4_6_v2_1'},
               'placement_mode': 'box_volume',
               'query_tags': ['UAVCorridor', 'HighAltitudeCorridor', 'event_semantic']},
              {'activation_tick': 0,
               'category': 'airspace_corridor',
               'enabled': True,
               'entity_id': 'corridor_l4_6_v2_uav_observer_l4_6_v2_1_01',
               'initial_state': {'custom_stencil_only': True,
                                 'mode': 'semantic_corridor',
                                 'semantic_class': 'uav_corridor'},
               'logical_asset_id': 'semantic.uav_corridor.segment.v1',
               'placement': {'altitude_layer_m': 30.0,
                             ...
                             'extent_m': [4.2, 4.0, 4.0],
                             'resolved_position_enu_m': [7068.916, 6319.524, 30.0],
                             'rotation_deg': {'pitch_deg': 0.0, 'roll_deg': 0.0, 'yaw_deg': 107.816},
                             'scale_xyz': [8.4, 8.0, 8.0],
                             'segment_end_enu_m': [7067.631, 6323.523, 30.0],
                             'segment_start_enu_m': [7070.201, 6315.526, 30.0],
                             'size_m': [8.4, 8.0, 8.0],
                             'source_uav_entity_id': 'uav_observer_l4_6_v2_1'},
               'placement_mode': 'box_volume',
               'query_tags': ['UAVCorridor', 'HighAltitudeCorridor', 'event_semantic']},
              {'activation_tick': 0,
               ...
               'category': 'vehicle',
               'entity_id': 'bg_vehicle_l4_6_v2_01',
               ...
               'placement': {'edge_id': 'cg_edge_122',
                             ...
                             'longitudinal_s': 213.0,
                             'placement_semantics': 'lane_center',
                             'resolved_lateral_from_center_m': 0.0,
                             'resolved_position_enu_m': [7097.991, 6326.361, 0.0],
                             'rotation_deg': {'yaw_deg': 24.11},
                             'source_edge_id_hint': 'cg_edge_122',
                             'source_longitudinal_s_hint': 213.0},
               'placement_mode': 'lane_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7097.814, 6327.294, 0.0],
                  'radius_m': 195.265,
 ...
 'spawn_sequencing': [{'entity_id': 'ped_jaywalk_l4_6_v2', 'tick': 0},
                      ...
                      {'entity_id': 'uav_observer_l4_6_v2_1', 'tick': 0},
                      {'entity_id': 'pad_home_uav_observer_l4_6_v2_1', 'tick': 0},
                      {'entity_id': 'corridor_l4_6_v2_uav_observer_l4_6_v2_1_00', 'tick': 0},
                      {'entity_id': 'corridor_l4_6_v2_uav_observer_l4_6_v2_1_01', 'tick': 0},
                      {'entity_id': 'bg_vehicle_l4_6_v2_01', 'tick': 0}],
 'validation_rules': [{'description': 'ped_jaywalk_l4_6_v2 is declared before event_script references it in L4-6_v2',
                      ...
                      {'description': 'Background road vehicles must stay clear of overlays, logical regions, pads, '
                       ...
                       'entity_ids': ['bg_vehicle_l4_6_v2_01'],
                       'min_count': 1,
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_observer_l4_6_v2_1_takeoff_entry',
                                          ...
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7067.631, 6323.523, 30.0],
                                                              [7070.201, 6315.526, 30.0]]},
                               'type': 'move_entity'}],
                  'event_id': 'lifecycle_takeoff_uav_observer_l4_6_v2_1',
                  'log_category': 'uav_lifecycle',
                  'log_overlay': 'uav_lifecycle',
                  'log_severity': 'info',
                  'log_target_ids': ['uav_observer_l4_6_v2_1', 'pad_home_uav_observer_l4_6_v2_1'],
                  'log_title': 'UAV takes off from visible home pad and enters mission airspace',
                  'log_topic': 'evt_L4-6_v2_lifecycle_takeoff_uav_observer_l4_6_v2_1',
                  'max_fire_count': 1,
                  'on_fire_emit': [],
                  'priority': 0,
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_observer_l4_6_v2_1_landing_return',
                                          'entity_id': 'uav_observer_l4_6_v2_1',
                                          'type': 'move_entity',
                                          'uav_corridor_validation': {'assigned_altitude_m': 30.0,
                                                                      ...
                                                                      'status': 'waypoints_repaired_for_building_clearance'},
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7070.201, 6315.526, 30.0],
                                                              [7067.631, 6323.523, 30.0]]},
                               'type': 'move_entity'}],
                  'event_id': 'lifecycle_landing_uav_observer_l4_6_v2_1',
                  'log_category': 'uav_lifecycle',
                  'log_overlay': 'uav_lifecycle',
                  'log_severity': 'info',
                  'log_target_ids': ['uav_observer_l4_6_v2_1', 'pad_home_uav_observer_l4_6_v2_1'],
                  'log_title': 'UAV returns to the visible home pad and lands after mission resolution',
                  'log_topic': 'evt_L4-6_v2_lifecycle_landing_uav_observer_l4_6_v2_1',
                  'max_fire_count': 1,
                  'on_fire_emit': [],
                  'priority': 9,
                  'trigger': {'delay_ticks': 80, 'event_ref': 'ped_retreats', 'type': 'event_fired_after'}}],
 'parameters': {'allow_building_impact': False,
                'background_vehicle_policy': {'added_entity_ids': ['bg_vehicle_l4_6_v2_01'],
                                              'policy': 'road_context_non_event_actor_v1',
                                              'reason': 'jaywalk conflict background traffic',
                                              'requested_count': 1},
                'incident_tick': 260,
                ...
                'uav_assigned_altitudes_m': {'uav_observer_l4_6_v2_1': 30.0},
                ...
                'uav_corridor_segments': [{'assigned_altitude_m': 30.0,
                                           ...
                                           'point_count': 3,
                                           'used_lateral_bypass': True}],
                'uav_lateral_bypass_used': {'uav_observer_l4_6_v2_1': True}},
 'scenario_id': 'L4-6_v2'}
