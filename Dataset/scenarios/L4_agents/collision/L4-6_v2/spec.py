...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7117.986, 6322.452, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'crosswalk_id': 'crosswalk_l4_6_v2',
                             ...
                             'longitudinal_s': 218.0,
                             'offset_from_curb_m': 1.2,
                             'opposite_curb_position_enu_m': [7101.246, 6331.229, 0.0],
                             'placement_semantics': 'crosswalk_curb_start',
                             'resolved_lateral_from_center_m': -3.1,
                             'resolved_position_enu_m': [7103.804, 6325.581, 0.0],
                             'roadway_center_position_enu_m': [7102.525, 6328.405, 0.0],
                             'rotation_deg': {'yaw_deg': 24.372},
                             'side': 'west'},
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7117.986, 6322.452, 0.0],
                  'radius_m': 174.523,
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'pedestrian.cityops.basic.v1',
               'entity_id': 'ped_jaywalk_l4_6_v2',
               'initial_pos_enu': [7103.804, 6325.581, 0.0],
               'initial_rotation_deg': [0.0, 0.0, 24.372],
               'movement_waypoints': [],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_ped_from_crosswalk_to_lane',
                                          'entity_id': 'ped_jaywalk_l4_6_v2',
                                          'velocity_mps': 1.6,
                                          'waypoints_enu_m': [[7103.804, 6325.581, 0.0], [7102.525, 6328.405, 0.0]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_car_toward_crosswalk',
                                          'entity_id': 'car_jaywalk_l4_6_v2',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[7132.167, 6319.323, 0.0], [7102.525, 6328.405, 0.0]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_car_hard_brake_ped',
                                          'entity_id': 'car_jaywalk_l4_6_v2',
                                          'velocity_mps': 0.8,
                                          'waypoints_enu_m': [[7102.525, 6328.405, 0.0], [7103.525, 6328.705, 0.0]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_ped_retreat_sidewalk',
                                          'entity_id': 'ped_jaywalk_l4_6_v2',
                                          'velocity_mps': 1.8,
                                          'waypoints_enu_m': [[7102.525, 6328.405, 0.0], [7101.246, 6331.229, 0.0]]},
                               'type': 'move_entity'}],
