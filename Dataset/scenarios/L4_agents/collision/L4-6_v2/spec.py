"""
Auto-generated P0 scenario spec for: L4-6_v2
Event type: L4-6 — Pedestrian-Vehicle Conflict
Category: collision
CAAC ref: CAAC-14 related (injury from vehicle)
SORA SAIL: I-II
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L4-6_v2",
        category="collision.l4-6",
        description="Vehicle runs red light, pedestrian jumps back",
        duration_ticks=900,
    )
