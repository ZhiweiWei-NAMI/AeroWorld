...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7125.823, 6337.716, 133.791],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'contract_inspect_uav': {'corridor_role': 'inspect_observer',
                                        ...
                                        'loop_route_enu_m': [[7084.255, 6320.536, 10.0],
               ...
               'placement': {'position_enu_m': [7084.255, 6320.536, 10.0],
                             'resolved_position_enu_m': [7084.255, 6320.536, 10.0],
                             'rotation_deg': {'yaw_deg': 45.0}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7166.211, 6357.484, 10.0],
                                         [7084.255, 6320.536, 10.0],
                                         [7166.211, 6357.484, 10.0]],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7070.201, 6315.526, 50.0],
                             'resolved_position_enu_m': [7070.201, 6315.526, 50.0],
                             'rotation_deg': {'yaw_deg': 23.883}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7179.746, 6364.03, 50.0]],
               'uav_corridor': {'altitude_layers_m': [30.0, 50.0, 80.0],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7066.53, 6326.951, 80.0],
                             'resolved_position_enu_m': [7066.53, 6326.951, 80.0],
                             'rotation_deg': {'yaw_deg': 23.912}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7174.525, 6374.835, 80.0]],
               'uav_corridor': {'altitude_layers_m': [30.0, 50.0, 80.0],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'altitude_layer_m': 10.0,
                             'center_enu_m': [7125.233, 6339.01, 10.0],
                             'extent_m': [44.95, 4.0, 4.0],
                             'resolved_position_enu_m': [7125.233, 6339.01, 10.0],
                             'rotation_deg': {'pitch_deg': 0.0, 'roll_deg': 0.0, 'yaw_deg': 24.267},
                             'scale_xyz': [89.9, 8.0, 8.0],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'altitude_layer_m': 10.0,
                             ...
                             'extent_m': [44.95, 4.0, 4.0],
                             'resolved_position_enu_m': [7125.233, 6339.01, 10.0],
                             'rotation_deg': {'pitch_deg': 0.0, 'roll_deg': 0.0, 'yaw_deg': -155.733},
                             'scale_xyz': [89.9, 8.0, 8.0],
               ...
               'placement_mode': 'box_volume',
               'query_tags': ['UAVCorridor', 'HighAltitudeCorridor', 'event_semantic']}],
 'local_bounds': {'center_enu_m': [7125.823, 6337.716, 0.0],
                  'radius_m': 221.235,
 ...
 'validation_rules': [{'description': 'ped_jaywalk_l4_6_v2 is declared before event_script references it in L4-6_v2',
                      ...
                      {'contract': {'background_semantics': {'pedestrian_role': 'retreat/wait',
                                    ...
                                    'capture_boundary': {'anchor_entity_roles': ['capture_boundary',
                                                                                 'hazard_zone',
                                                                                 'airspace_constraint'],
                                                         'boundary_id': 'capture_boundary.L4-6_v2.primary',
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'pedestrian.cityops.basic.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'u_inspect_l4_6_v2',
               'initial_pos_enu': [7084.255, 6320.536, 10.0],
               'initial_rotation_deg': [0.0, 0.0, 45.0],
               'movement_waypoints': [[7166.211, 6357.484, 10.0],
                                      [7084.255, 6320.536, 10.0],
                                      [7166.211, 6357.484, 10.0]],
              ...
              {'asset_id': 'uav.airsim.flying_pawn.v1',
               'entity_id': 'uav_observer_l4_6_v2_2',
               'initial_pos_enu': [7070.201, 6315.526, 50.0],
               'initial_rotation_deg': [0.0, 0.0, 23.883],
               'movement_waypoints': [[7179.746, 6364.03, 50.0]],
              ...
              {'asset_id': 'uav.airsim.cv_pawn.v1',
               'entity_id': 'uav_observer_l4_6_v2_3',
               'initial_pos_enu': [7066.53, 6326.951, 80.0],
               'initial_rotation_deg': [0.0, 0.0, 23.912],
               'movement_waypoints': [[7174.525, 6374.835, 80.0]],
              ...
              {'asset_id': 'semantic.uav_corridor.segment.v1',
               'entity_id': 'corridor_l4_6_v2_u_inspect_l4_6_v2_00',
               'initial_pos_enu': [7125.233, 6339.01, 10.0],
               'initial_rotation_deg': [0.0, 0.0, 24.267],
               'movement_waypoints': [],
               'visual_state': {'mode': 'semantic_corridor'}},
              {'asset_id': 'semantic.uav_corridor.segment.v1',
               'entity_id': 'corridor_l4_6_v2_u_inspect_l4_6_v2_01',
               'initial_pos_enu': [7125.233, 6339.01, 10.0],
               'initial_rotation_deg': [0.0, 0.0, -155.733],
               'movement_waypoints': [],
               'visual_state': {'mode': 'semantic_corridor'}}],
 ...
 'parameters': {'allow_building_impact': False,
                ...
                'uav_corridor_segment_details': [{'assigned_altitude_m': 10.0,
                                                 ...
                                                 {'assigned_altitude_m': 50.0,
                                                  'entity_id': 'uav_observer_l4_6_v2_2',
                                                  'segment_end_enu_m': [7179.746, 6364.03, 50.0],
                                                  'segment_index': 0,
                                                  'segment_start_enu_m': [7070.201, 6315.526, 50.0]},
                                                 {'assigned_altitude_m': 80.0,
                                                  'entity_id': 'uav_observer_l4_6_v2_3',
                                                  'segment_end_enu_m': [7174.525, 6374.835, 80.0],
                                                  'segment_index': 0,
