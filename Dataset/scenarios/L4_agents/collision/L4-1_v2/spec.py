...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7046.5, 6291.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7027.5, 6285.0, 25],
                             'resolved_position_enu_m': [7027.5, 6285.0, 25],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7065.5, 6297.0, 30],
                             'resolved_position_enu_m': [7065.5, 6297.0, 30],
                             'rotation_deg': {'yaw_deg': 250}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7046.5, 6291.0, 0.0], 'radius_m': 179.925, 'source': 'scene_entities_and_routes'},
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_a_converge',
                                          'entity_id': 'uav_conflict_l4_1_v2_a',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[7027.5, 6285.0, 25],
                                                              [7042.5, 6289.0, 25],
                                                              [7047.5, 6291.0, 28]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_uav_b_converge',
                                          'entity_id': 'uav_conflict_l4_1_v2_b',
                                          'velocity_mps': 7.5,
                                          'waypoints_enu_m': [[7065.5, 6297.0, 30],
                                                              [7053.5, 6293.0, 30],
                                                              [7047.5, 6291.0, 28]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_a_hover',
                              ...
                              {'params': {'action_id': 'move_uav_b_altitude_reroute',
                                          'entity_id': 'uav_conflict_l4_1_v2_b',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[7047.5, 6291.0, 28], [7059.5, 6303.0, 36]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_a_resume',
                                          'entity_id': 'uav_conflict_l4_1_v2_a',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[7047.5, 6291.0, 28], [7029.5, 6305.0, 27]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_uav_b_resume',
                                          'entity_id': 'uav_conflict_l4_1_v2_b',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7059.5, 6303.0, 36], [7071.5, 6307.0, 32]]},
                               'type': 'move_entity'}],
