...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7049.96, 6288.588, 86.089],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7030.619, 6270.783, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_conflict_l4_1_v2_a',
                             'mission_start_enu_m': [7027.5, 6285.0, 25],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7030.619, 6270.783, 3.0],
                             'resolved_position_enu_m': [7030.619, 6270.783, 3.0],
                             'rotation_deg': {'yaw_deg': 70}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7027.5, 6285.0, 25]]},
              {'activation_tick': 0,
               'category': 'uav',
               'entity_id': 'uav_conflict_l4_1_v2_b',
               'initial_state': {'mode': 'preflight_on_pad'},
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7071.515, 6285.155, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_conflict_l4_1_v2_b',
                             'mission_start_enu_m': [7065.5, 6297.0, 30],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.airsim.flying_pawn.v1',
               'placement': {'position_enu_m': [7071.515, 6285.155, 3.0],
                             'resolved_position_enu_m': [7071.515, 6285.155, 3.0],
                             'rotation_deg': {'yaw_deg': 250}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7065.5, 6297.0, 30]]},
              {'activation_tick': 0,
               'category': 'facility',
              ...
              {'activation_tick': 0,
               ...
               'placement_mode': 'pad_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7049.96, 6288.588, 0.0],
                  'radius_m': 188.337,
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_conflict_l4_1_v2_a',
               'initial_pos_enu': [7030.619, 6270.783, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 70],
               'movement_waypoints': [[7027.5, 6285.0, 25]],
               'visual_state': {'mode': 'preflight_on_pad'}},
              {'asset_id': 'uav.airsim.flying_pawn.v1',
               'entity_id': 'uav_conflict_l4_1_v2_b',
               'initial_pos_enu': [7071.515, 6285.155, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 250],
               'movement_waypoints': [[7065.5, 6297.0, 30]],
               'visual_state': {'mode': 'preflight_on_pad'}},
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_conflict_l4_1_v2_a_takeoff_entry',
                                          'entity_id': 'uav_conflict_l4_1_v2_a',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7030.619, 6270.783, 3.0],
                                                              [7030.619, 6270.783, 21.0],
                                                              [7027.5, 6285.0, 25]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_conflict_l4_1_v2_b_takeoff_entry',
                                          'entity_id': 'uav_conflict_l4_1_v2_b',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7071.515, 6285.155, 3.0],
                                                              [7071.515, 6285.155, 24.0],
                                                              [7065.5, 6297.0, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_conflict_l4_1_v2_a_landing_return',
                                          'entity_id': 'uav_conflict_l4_1_v2_a',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7029.5, 6305.0, 27.0],
                                                              [7030.619, 6270.783, 22.0],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_conflict_l4_1_v2_b_landing_return',
                                          'entity_id': 'uav_conflict_l4_1_v2_b',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7071.5, 6307.0, 32.0],
                                                              [7071.515, 6285.155, 22.0],
                                                              [7071.515, 6285.155, 3.0]]},
                               'type': 'move_entity'}],
