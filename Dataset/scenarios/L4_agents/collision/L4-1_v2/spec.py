"""
Auto-generated P0 scenario spec for: L4-1_v2
Event type: L4-1 — UAV-UAV Airspace Conflict
Category: collision
CAAC ref: CAAC-2 (mid-air collision or near-miss)
SORA SAIL: V-VI
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L4-1_v2",
        category="collision.l4-1",
        description="Actual mid-air collision, debris fall",
        duration_ticks=900,
    )
