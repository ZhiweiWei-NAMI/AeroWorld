...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7037.057, 6285.025, 77.332],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7029.662, 6270.572, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_facade_l4_2_v1',
                             'mission_start_enu_m': [7028.0, 6279.0, 31],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7029.662, 6270.572, 3.0],
                             'resolved_position_enu_m': [7029.662, 6270.572, 3.0],
                             'rotation_deg': {'yaw_deg': 55}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7028.0, 6279.0, 31]]},
              {'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7037.057, 6285.025, 0.0],
                  'radius_m': 182.298,
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_facade_l4_2_v1',
               'initial_pos_enu': [7029.662, 6270.572, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 55],
               'movement_waypoints': [[7028.0, 6279.0, 31]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_facade_l4_2_v1_takeoff_entry',
                                          'entity_id': 'uav_facade_l4_2_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7029.662, 6270.572, 3.0],
                                                              [7029.662, 6270.572, 24.0],
                                                              [7028.0, 6279.0, 31]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_approach',
                                          'entity_id': 'uav_facade_l4_2_v1',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7028.0, 6279.0, 31],
                                                              [7041.0, 6286.0, 26],
                                                              [7055.0, 6294.0, 18]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_evasion',
                                          'entity_id': 'uav_facade_l4_2_v1',
                                          'velocity_mps': 10.0,
                                          'waypoints_enu_m': [[7055.0, 6294.0, 18], [7049.0, 6302.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_recover',
                                          'entity_id': 'uav_facade_l4_2_v1',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7049.0, 6302.0, 34], [7031.0, 6306.0, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_l4_2_v1_landing_return',
                                          'entity_id': 'uav_facade_l4_2_v1',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7031.0, 6306.0, 32.0],
                                                              [7029.662, 6270.572, 22.0],
                                                              [7029.662, 6270.572, 3.0]]},
                               'type': 'move_entity'}],
