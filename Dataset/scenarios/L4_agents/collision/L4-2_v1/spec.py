"""
Auto-generated P0 scenario spec for: L4-2_v1
Event type: L4-2 — UAV Building/Structure Strike
Category: collision
CAAC ref: CAAC-4 (striking obstacles), CAAC-13 (collision with facilities)
SORA SAIL: V-VI
Severity: major
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L4-2_v1",
        category="collision.l4-2",
        description="Near-miss with building, last-second avoidance",
        duration_ticks=900,
    )
