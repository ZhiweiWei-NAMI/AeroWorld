...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [42.5, 87.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [28.0, 79.0, 31], 'rotation_deg': {'yaw_deg': 55}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'building_id': 'building_east_block_2',
                             'outward_normal_enu': [1.0, -0.4, 0.0],
                             'position_enu_m': [57.0, 95.0, 16],
                             'stand_off_m': 1.0},
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_facade_approach',
                                          'entity_id': 'uav_facade_l4_2_v1',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[28.0, 79.0, 31], [41.0, 86.0, 26], [55.0, 94.0, 18]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_evasion',
                                          'entity_id': 'uav_facade_l4_2_v1',
                                          'velocity_mps': 10.0,
                                          'waypoints_enu_m': [[55.0, 94.0, 18], [49.0, 102.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_recover',
                                          'entity_id': 'uav_facade_l4_2_v1',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[49.0, 102.0, 34], [31.0, 106.0, 32]]},
                               'type': 'move_entity'}],
