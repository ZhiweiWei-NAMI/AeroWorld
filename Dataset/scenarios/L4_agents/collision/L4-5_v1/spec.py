...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7088.345, 6304.541, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7082.5, 6301.0, 30],
                             'resolved_position_enu_m': [7082.5, 6301.0, 30],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_204',
                             ...
                             'resolved_position_enu_m': [7094.19, 6308.081, 0.0],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_ped_descent',
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_hover_nearmiss',
                              ...
                              {'params': {'action_id': 'move_uav_pull_up_after_nearmiss',
                                          'entity_id': 'uav_ped_nearmiss_l4_5_v1',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[7094.19, 6308.081, 5], [7086.19, 6316.081, 24]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_ped_clear_nearmiss',
                                          'entity_id': 'ped_nearmiss_l4_5_v1',
                                          'velocity_mps': 1.5,
                                          'waypoints_enu_m': [[7094.19, 6308.081, 0.0], [7105.863, 6313.264, 0.0]]},
                               'type': 'move_entity'}],
