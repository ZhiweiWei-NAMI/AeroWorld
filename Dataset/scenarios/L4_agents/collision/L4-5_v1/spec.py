...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [6988.191, 6237.948, 180.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7079.276, 6307.774, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_ped_nearmiss_l4_5_v1',
                             'mission_start_enu_m': [7082.5, 6301.0, 30],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7079.276, 6307.774, 3.0],
                             'resolved_position_enu_m': [7079.276, 6307.774, 3.0],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7082.5, 6301.0, 30]]},
              {'activation_tick': 0,
               'category': 'pedestrian',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'approach_side': 'departure',
                             ...
                             'position_enu_m': [7079.276, 6307.774, 0.0],
                             'resolved_position_enu_m': [7079.276, 6307.774, 0.0],
                             'rotation_deg': {'yaw_deg': 22.837}},
               'placement_mode': 'pad_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [6988.191, 6237.948, 0.0],
                  'radius_m': 325.864,
 ...
 'scenario_id': 'L4-5_v1',
 'spawn_sequencing': [{'entity_id': 'uav_ped_nearmiss_l4_5_v1', 'tick': 0},
                      {'entity_id': 'ped_nearmiss_l4_5_v1', 'tick': 0},
                      {'entity_id': 'pad_home_uav_ped_nearmiss_l4_5_v1', 'tick': 0}],
 'validation_rules': [{'description': 'uav_ped_nearmiss_l4_5_v1 is declared before event_script references it in '
                                      'L4-5_v1',
                       'entity_id': 'uav_ped_nearmiss_l4_5_v1',
                       'rule': 'entity_resolvable'},
                      {'description': 'ped_nearmiss_l4_5_v1 is declared before event_script references it in L4-5_v1',
                       'entity_id': 'ped_nearmiss_l4_5_v1',
                       'rule': 'entity_resolvable'},
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_ped_nearmiss_l4_5_v1',
               'initial_pos_enu': [7079.276, 6307.774, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7082.5, 6301.0, 30]],
              ...
              {'asset_id': 'facility.landing_pad.visible.v1',
               'entity_id': 'pad_home_uav_ped_nearmiss_l4_5_v1',
               'initial_pos_enu': [7079.276, 6307.774, 0.0],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_ped_nearmiss_l4_5_v1_takeoff_entry',
                                          'entity_id': 'uav_ped_nearmiss_l4_5_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7079.276, 6307.774, 3.0],
                                                              [7079.276, 6307.774, 24.0],
                                                              [7082.5, 6301.0, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_ped_descent',
                                          'entity_id': 'uav_ped_nearmiss_l4_5_v1',
                                          'velocity_mps': 4.5,
                                          'waypoints_enu_m': [[7082.5, 6301.0, 30],
                                                              [7088.5, 6307.0, 15],
                                                              [6857.804, 6138.514, 5]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_ped_nearmiss_l4_5_v1_landing_return',
                                          ...
                                          'waypoints_enu_m': [[6849.804, 6146.514, 24.0],
                                                              [7079.276, 6307.774, 22.0],
                                                              [7079.276, 6307.774, 3.0]]},
                               'type': 'move_entity'}],
