...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [99.0, 111.5, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [93.5, 107.0, 30], 'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_21', 'longitudinal_s': 35, 'offset_from_curb_m': 1.2},
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_ped_descent',
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_hover_nearmiss',
                              ...
                              {'params': {'action_id': 'move_uav_pull_up_after_nearmiss',
                                          'entity_id': 'uav_ped_nearmiss_l4_5_v3',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[104.5, 116.0, 5], [95.5, 124.0, 24]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_ped_clear_nearmiss',
                                          'entity_id': 'ped_nearmiss_l4_5_v3',
                                          'velocity_mps': 1.5,
                                          'waypoints_enu_m': [[104.5, 116.0, 0], [111.5, 126.0, 0]]},
                               'type': 'move_entity'}],
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'pedestrian_near_miss', 'type': 'event_fired'}}],
