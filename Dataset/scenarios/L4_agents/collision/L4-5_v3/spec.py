...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7099.789, 6309.852, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7093.5, 6307.0, 30],
                             'resolved_position_enu_m': [7093.5, 6307.0, 30],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_204',
                             ...
                             'resolved_position_enu_m': [7106.079, 6312.704, 0.0],
                             'rotation_deg': {'yaw_deg': 21.065},
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_ped_nearmiss_l4_5_v3',
               'initial_pos_enu': [7093.5, 6307.0, 30],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [],
               'visual_state': {'mode': 'descent'}},
              {'asset_id': 'pedestrian.cityops.basic.v1',
               'entity_id': 'ped_nearmiss_l4_5_v3',
               'initial_pos_enu': [7106.079, 6312.704, 0.0],
               'initial_rotation_deg': [0.0, 0.0, 21.065],
               'movement_waypoints': [],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_ped_descent',
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_hover_nearmiss',
                              ...
                              {'params': {'action_id': 'move_uav_pull_up_after_nearmiss',
                                          'entity_id': 'uav_ped_nearmiss_l4_5_v3',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[7106.079, 6312.704, 5], [7098.079, 6320.704, 24]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_ped_clear_nearmiss',
                                          'entity_id': 'ped_nearmiss_l4_5_v3',
                                          'velocity_mps': 1.5,
                                          'waypoints_enu_m': [[7106.079, 6312.704, 0.0], [7117.831, 6317.844, 0.0]]},
                               'type': 'move_entity'}],
