...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [6995.034, 6241.081, 180.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7091.333, 6312.651, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_ped_nearmiss_l4_5_v3',
                             'mission_start_enu_m': [7093.5, 6307.0, 30],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7091.333, 6312.651, 3.0],
                             'resolved_position_enu_m': [7091.333, 6312.651, 3.0],
                             'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7093.5, 6307.0, 30]]},
              {'activation_tick': 0,
               'category': 'pedestrian',
              ...
              {'activation_tick': 0,
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [6995.034, 6241.081, 0.0],
                  'radius_m': 333.305,
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_ped_nearmiss_l4_5_v3',
               'initial_pos_enu': [7091.333, 6312.651, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 45],
               'movement_waypoints': [[7093.5, 6307.0, 30]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_ped_nearmiss_l4_5_v3_takeoff_entry',
                                          'entity_id': 'uav_ped_nearmiss_l4_5_v3',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7091.333, 6312.651, 3.0],
                                                              [7091.333, 6312.651, 24.0],
                                                              [7093.5, 6307.0, 30]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_ped_descent',
                                          'entity_id': 'uav_ped_nearmiss_l4_5_v3',
                                          'velocity_mps': 4.5,
                                          'waypoints_enu_m': [[7093.5, 6307.0, 30],
                                                              [7099.5, 6313.0, 15],
                                                              [6857.804, 6138.514, 5]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_ped_nearmiss_l4_5_v3_landing_return',
                                          ...
                                          'waypoints_enu_m': [[6849.804, 6146.514, 24.0],
                                                              [7091.333, 6312.651, 22.0],
                                                              [7091.333, 6312.651, 3.0]]},
                               'type': 'move_entity'}],
