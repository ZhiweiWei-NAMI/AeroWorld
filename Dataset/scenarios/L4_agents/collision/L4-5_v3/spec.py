"""
Auto-generated P0 scenario spec for: L4-5_v3
Event type: L4-5 — UAV-Pedestrian Near-Miss/Interaction
Category: collision
CAAC ref: CAAC-13 (collision with personnel), CAAC-14 (injury)
SORA SAIL: V-VI
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L4-5_v3",
        category="collision.l4-5",
        description="UAV strikes pedestrian in crowd",
        duration_ticks=900,
    )
