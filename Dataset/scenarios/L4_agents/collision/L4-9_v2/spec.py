"""
Auto-generated P0 scenario spec for: L4-9_v2
Event type: L4-9 — Ground Vehicle Collision
Category: collision
CAAC ref: Non-emergency (traffic accident)
SORA SAIL: I
Severity: major
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L4-9_v2",
        category="collision.l4-9",
        description="T-bone collision at intersection, full blockage",
        duration_ticks=900,
    )
