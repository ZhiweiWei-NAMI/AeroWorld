...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7041.041, 6293.234, 76.874],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7030.865, 6288.331, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_facade_l4_2_v2',
                             'mission_start_enu_m': [7033.5, 6282.0, 31],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7030.865, 6288.331, 3.0],
                             'resolved_position_enu_m': [7030.865, 6288.331, 3.0],
                             'rotation_deg': {'yaw_deg': 55}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7033.5, 6282.0, 31]]},
              {'activation_tick': 0,
               'category': 'facade_anchor',
               'entity_id': 'facade_anchor_l4_2_v2',
               'initial_state': {},
               'logical_asset_id': 'semantic.asset_anchor',
               'placement': {'building_id': 'building_geojson_301082024',
                             ...
                             'position_enu_m': [7062.5, 6298.0, 16],
                             'resolved_position_enu_m': [7062.5, 6298.0, 16],
                             'stand_off_m': 1.0},
               'placement_mode': 'facade_anchor',
               'route_waypoints_enu_m': []},
              {'activation_tick': 0,
               'category': 'facility',
               'entity_id': 'pad_home_uav_facade_l4_2_v2',
               'initial_state': {'mode': 'available'},
               'logical_asset_id': 'facility.landing_pad.visible.v1',
               'placement': {'approach_side': 'departure',
                             'pad_instance_id': 'home_uav_facade_l4_2_v2',
                             'position_enu_m': [7030.865, 6288.331, 0.0],
                             'resolved_position_enu_m': [7030.865, 6288.331, 0.0],
                             'rotation_deg': {'yaw_deg': 18.993}},
               'placement_mode': 'pad_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7041.041, 6293.234, 0.0],
                  'radius_m': 181.982,
 ...
 'spawn_sequencing': [{'entity_id': 'uav_facade_l4_2_v2', 'tick': 0},
                      ...
                      {'entity_id': 'pad_home_uav_facade_l4_2_v2', 'tick': 0}],
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_facade_l4_2_v2',
               'initial_pos_enu': [7030.865, 6288.331, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 55],
               'movement_waypoints': [[7033.5, 6282.0, 31]],
               'visual_state': {'mode': 'preflight_on_pad'}},
              {'asset_id': 'semantic.asset_anchor',
               'entity_id': 'facade_anchor_l4_2_v2',
               'initial_pos_enu': [7062.5, 6298.0, 16],
               'initial_rotation_deg': [0.0, 0.0, 0.0],
               'movement_waypoints': [],
               'visual_state': None},
              {'asset_id': 'facility.landing_pad.visible.v1',
               'entity_id': 'pad_home_uav_facade_l4_2_v2',
               'initial_pos_enu': [7030.865, 6288.331, 0.0],
               'initial_rotation_deg': [0.0, 0.0, 18.993],
               'movement_waypoints': [],
               'visual_state': {'mode': 'available'}}],
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_facade_l4_2_v2_takeoff_entry',
                                          'entity_id': 'uav_facade_l4_2_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7030.865, 6288.331, 3.0],
                                                              [7030.865, 6288.331, 24.0],
                                                              [7033.5, 6282.0, 31]]},
                               'type': 'move_entity'}],
                  'event_id': 'lifecycle_takeoff_uav_facade_l4_2_v2',
                  'log_category': 'uav_lifecycle',
                  'log_overlay': 'uav_lifecycle',
                  'log_severity': 'info',
                  'log_target_ids': ['uav_facade_l4_2_v2', 'pad_home_uav_facade_l4_2_v2'],
                  'log_title': 'UAV takes off from visible home pad and enters mission airspace',
                  'log_topic': 'evt_L4-2_v2_lifecycle_takeoff_uav_facade_l4_2_v2',
                  'max_fire_count': 1,
                  'on_fire_emit': [],
                  'priority': 0,
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_approach',
                                          'entity_id': 'uav_facade_l4_2_v2',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7033.5, 6282.0, 31],
                                                              [7046.5, 6289.0, 26],
                                                              [7060.5, 6297.0, 18]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_evasion',
                                          'entity_id': 'uav_facade_l4_2_v2',
                                          'velocity_mps': 10.0,
                                          'waypoints_enu_m': [[7060.5, 6297.0, 18], [7054.5, 6305.0, 34]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_recover',
                                          'entity_id': 'uav_facade_l4_2_v2',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[7054.5, 6305.0, 34], [7036.5, 6309.0, 32]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_facade_l4_2_v2_landing_return',
                                          'entity_id': 'uav_facade_l4_2_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7036.5, 6309.0, 32.0],
                                                              [7030.865, 6288.331, 22.0],
                                                              [7030.865, 6288.331, 3.0]]},
                               'type': 'move_entity'}],
                  'event_id': 'lifecycle_landing_uav_facade_l4_2_v2',
                  'log_category': 'uav_lifecycle',
                  'log_overlay': 'uav_lifecycle',
                  'log_severity': 'info',
                  'log_target_ids': ['uav_facade_l4_2_v2', 'pad_home_uav_facade_l4_2_v2'],
                  'log_title': 'UAV returns to the visible home pad and lands after mission resolution',
                  'log_topic': 'evt_L4-2_v2_lifecycle_landing_uav_facade_l4_2_v2',
                  'max_fire_count': 1,
                  'on_fire_emit': [],
                  'priority': 9,
