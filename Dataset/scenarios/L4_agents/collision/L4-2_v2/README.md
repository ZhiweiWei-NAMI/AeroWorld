# L4-2_v2: physically animated semantic chain with a clear key event and continuous interaction
...
## Chain
facade near miss > recovery

## Actors
Entities: semantic UAVs, background vehicles/pedestrians where present, and scenario-specific facilities/logical actors.
- Background vehicle semantics: moving/stopped near building
- Background pedestrian semantics: facade-scale pedestrians
