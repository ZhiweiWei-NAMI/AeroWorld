...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [6982.348, 6230.676, 180.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_550',
                             ...
                             'resolved_position_enu_m': [6985.842, 6213.244, 0.0],
                             'rotation_deg': {'yaw_deg': -167.357},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_550',
                             ...
                             'placement_semantics': 'lane_center',
                             'resolved_lateral_from_center_m': 0.0,
                             'resolved_position_enu_m': [7003.438, 6217.041, 0.0],
                             'rotation_deg': {'yaw_deg': -168.123},
                             'source_edge_id_hint': 'cg_edge_550',
                             'source_longitudinal_s_hint': 43.0},
               'placement_mode': 'lane_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [6982.348, 6230.676, 0.0],
                  'radius_m': 317.007,
 ...
 'validation_rules': [{'description': 'uav_ped_nearmiss_l4_5_v2 is declared before event_script references it in '
                      ...
                      {'description': 'Background road vehicles must stay clear of overlays, logical regions, pads, '
                       ...
                       'entity_ids': ['bg_vehicle_l4_5_v2_01', 'bg_vehicle_l4_5_v2_02'],
                       'min_count': 2,
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'uav.inspect.quad.v1',
              ...
              {'asset_id': 'vehicle.ground.boxcar.v1',
               'entity_id': 'bg_vehicle_l4_5_v2_01',
               'initial_pos_enu': [6985.842, 6213.244, 0.0],
               'initial_rotation_deg': [0.0, 0.0, -167.357],
               'movement_waypoints': [],
               'visual_state': {'background_role': 'road_context', 'mode': 'background_parked'}},
              {'asset_id': 'vehicle.emergency.suv.v1',
               'entity_id': 'bg_vehicle_l4_5_v2_02',
               'initial_pos_enu': [7003.438, 6217.041, 0.0],
               'initial_rotation_deg': [0.0, 0.0, -168.123],
               'movement_waypoints': [],
               'visual_state': {'background_role': 'road_context', 'mode': 'background_parked'}}],
 ...
 'parameters': {'allow_building_impact': False,
                'background_vehicle_policy': {'added_entity_ids': ['bg_vehicle_l4_5_v2_01', 'bg_vehicle_l4_5_v2_02'],
                                              'policy': 'road_context_non_event_actor_v1',
                                              'reason': 'pedestrian near-miss road context',
                                              'requested_count': 2},
                'incident_tick': 260,
                ...
                'uav_assigned_altitudes_m': {'uav_ped_nearmiss_l4_5_v2': 50.0},
                ...
                'uav_corridor_segments': [{'assigned_altitude_m': 50.0,
                                           ...
                                           'point_count': 6,
                                           'used_lateral_bypass': True}],
                'uav_lateral_bypass_used': {'uav_ped_nearmiss_l4_5_v2': True}},
 'scenario_id': 'L4-5_v2'}
