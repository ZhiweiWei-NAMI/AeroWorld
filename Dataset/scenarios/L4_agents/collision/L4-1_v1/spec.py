...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [41.0, 88.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [22.0, 82.0, 25], 'rotation_deg': {'yaw_deg': 70}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [60.0, 94.0, 30], 'rotation_deg': {'yaw_deg': 250}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_a_converge',
                                          'entity_id': 'uav_conflict_l4_1_v1_a',
                                          'velocity_mps': 8.0,
                                          'waypoints_enu_m': [[22.0, 82.0, 25], [37.0, 86.0, 25], [42.0, 88.0, 28]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_uav_b_converge',
                                          'entity_id': 'uav_conflict_l4_1_v1_b',
                                          'velocity_mps': 7.5,
                                          'waypoints_enu_m': [[60.0, 94.0, 30], [48.0, 90.0, 30], [42.0, 88.0, 28]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'set_uav_a_hover',
                              ...
                              {'params': {'action_id': 'move_uav_b_altitude_reroute',
                                          'entity_id': 'uav_conflict_l4_1_v1_b',
                                          'velocity_mps': 9.0,
                                          'waypoints_enu_m': [[42.0, 88.0, 28], [54.0, 100.0, 36]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_a_resume',
                                          'entity_id': 'uav_conflict_l4_1_v1_a',
                                          'velocity_mps': 6.0,
                                          'waypoints_enu_m': [[42.0, 88.0, 28], [24.0, 102.0, 27]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_uav_b_resume',
                                          'entity_id': 'uav_conflict_l4_1_v1_b',
                                          'velocity_mps': 7.0,
                                          'waypoints_enu_m': [[54.0, 100.0, 36], [66.0, 104.0, 32]]},
                               'type': 'move_entity'}],
