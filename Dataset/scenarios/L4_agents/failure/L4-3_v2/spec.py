"""
Auto-generated P0 scenario spec for: L4-3_v2
Event type: L4-3 — UAV Forced Landing in Populated Area
Category: failure
CAAC ref: CAAC-2 (crash or forced landing), CAAC-14 (death or serious injury)
SORA SAIL: VI
Severity: critical
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        scenario_id="L4-3_v2",
        category="failure.l4-3",
        description="Uncontrolled descent near pedestrians",
        duration_ticks=900,
    )
