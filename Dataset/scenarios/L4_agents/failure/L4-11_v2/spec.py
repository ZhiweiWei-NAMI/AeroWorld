...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7154.703, 6357.08, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'lifecycle': {'auto_lifecycle_applied': True,
                             'home_hover_enu_m': [7149.963, 6359.006, 3.0],
                             'home_pad_entity_id': 'pad_home_uav_av_report_l4_11_v2',
                             'mission_start_enu_m': [7148.5, 6362.0, 33],
                             'requires_landing_or_terminal_resolution': True,
                             'requires_takeoff': True},
               'logical_asset_id': 'uav.inspect.quad.v1',
               'placement': {'position_enu_m': [7149.963, 6359.006, 3.0],
                             'resolved_position_enu_m': [7149.963, 6359.006, 3.0],
                             'rotation_deg': {'yaw_deg': 70}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': [[7148.5, 6362.0, 33]]},
              {'activation_tick': 0,
               'category': 'facility',
               ...
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7154.703, 6357.08, 0.0],
                  'radius_m': 176.927,
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'vehicle.ground.boxcar.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_av_report_l4_11_v2',
               'initial_pos_enu': [7149.963, 6359.006, 3.0],
               'initial_rotation_deg': [0.0, 0.0, 70],
               'movement_waypoints': [[7148.5, 6362.0, 33]],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'move_uav_av_report_l4_11_v2_takeoff_entry',
                                          'entity_id': 'uav_av_report_l4_11_v2',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[7149.963, 6359.006, 3.0],
                                                              [7149.963, 6359.006, 24.0],
                                                              [7148.5, 6362.0, 33]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_av_report_l4_11_v2_landing_return',
                                          'entity_id': 'uav_av_report_l4_11_v2',
                                          'velocity_mps': 4.0,
                                          'waypoints_enu_m': [[7168.5, 6357.0, 25.0],
                                                              [7149.963, 6359.006, 22.0],
                                                              [7149.963, 6359.006, 3.0]]},
                               'type': 'move_entity'}],
