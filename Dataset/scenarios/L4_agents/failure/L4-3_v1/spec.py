...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [63.0, 91.333, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [52.0, 82.0, 30], 'rotation_deg': {'yaw_deg': 45}},
               'placement_mode': 'world_pose',
              ...
              {'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_19', 'longitudinal_s': 24, 'offset_from_curb_m': 1.4},
              ...
              {'activation_tick': 0,
               ...
               'initial_state': {'mode': 'standing'},
               'logical_asset_id': 'pedestrian.cityops.basic.v1',
               'placement': {'lane_edge_id': 'cg_edge_19', 'longitudinal_s': 28, 'offset_from_curb_m': 1.4},
               'placement_mode': 'sidewalk_anchor',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_uav_forced_landing_fault',
                              ...
                              {'params': {'action_id': 'spawn_landing_crowd',
                                          ...
                                          'spawn_origin_enu_m': [68.0, 97.0, 0]},
                               'type': 'spawn_crowd'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_forced_descent',
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'forced_landing_fault', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_ped_a_evade_landing',
                                          'entity_id': 'ped_landing_l4_3_v1_a',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[66.0, 96.0, 0], [54.0, 104.0, 0]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_ped_b_evade_landing',
                                          'entity_id': 'ped_landing_l4_3_v1_b',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[71.0, 96.0, 0], [81.0, 106.0, 0]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_safe_touchdown',
                                          'entity_id': 'uav_forced_landing_l4_3_v1',
                                          'velocity_mps': 1.0,
                                          'waypoints_enu_m': [[69.0, 98.0, 3], [70.0, 99.0, 0.8]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'crowd_proximity_response', 'type': 'event_fired'}}],
