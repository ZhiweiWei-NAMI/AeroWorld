...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7061.706, 6293.568, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7052.0, 6282.0, 30],
                             'resolved_position_enu_m': [7052.0, 6282.0, 30],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_204',
                             ...
                             'resolved_position_enu_m': [7064.413, 6298.139, 0.0],
              ...
              {'activation_tick': 0,
               ...
               'placement': {'lane_edge_id': 'cg_edge_204',
                             ...
                             'placement_semantics': 'sidewalk_or_plaza',
                             'resolved_lateral_from_center_m': 6.4,
                             'resolved_position_enu_m': [7068.705, 6300.566, 0.0],
                             'rotation_deg': {'yaw_deg': 28.965},
                             'source_lane_edge_id_hint': 'cg_edge_19',
                             'source_longitudinal_s_hint': 28},
               'placement_mode': 'sidewalk_anchor',
               'route_waypoints_enu_m': []}],
 'local_bounds': {'center_enu_m': [7061.706, 6293.568, 0.0],
                  'radius_m': 175.101,
 ...
 'scenario_id': 'L4-3_v1',
 'spawn_sequencing': [{'entity_id': 'uav_forced_landing_l4_3_v1', 'tick': 0},
                      {'entity_id': 'ped_landing_l4_3_v1_a', 'tick': 0},
                      {'entity_id': 'ped_landing_l4_3_v1_b', 'tick': 0}],
 'validation_rules': [{'description': 'uav_forced_landing_l4_3_v1 is declared before event_script references it in '
                                      'L4-3_v1',
                       'entity_id': 'uav_forced_landing_l4_3_v1',
                       'rule': 'entity_resolvable'},
                      {'description': 'ped_landing_l4_3_v1_a is declared before event_script references it in '
                                      'L4-3_v1',
                       'entity_id': 'ped_landing_l4_3_v1_a',
                       'rule': 'entity_resolvable'},
...
SPEC_DATA = {'category': 'agents',
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_uav_forced_landing_fault',
                              ...
                              {'params': {'action_id': 'spawn_landing_crowd',
                                          ...
                                          'spawn_origin_enu_m': [7066.885, 6299.538, 0.0]},
                               'type': 'spawn_crowd'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_forced_descent',
                                          'entity_id': 'uav_forced_landing_l4_3_v1',
                                          'velocity_mps': 3.0,
                                          'waypoints_enu_m': [[7052.0, 6282.0, 30],
                                                              [7061.0, 6290.0, 18],
                                                              [7066.559, 6299.352, 8],
                                                              [7066.559, 6299.352, 3]]},
                               'type': 'move_entity'}],
                 ...
                 {'actions': [{'params': {'action_id': 'move_ped_a_evade_landing',
                                          'entity_id': 'ped_landing_l4_3_v1_a',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[7064.413, 6298.139, 0.0], [7056.504, 6304.899, 0.0]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'move_ped_b_evade_landing',
                                          'entity_id': 'ped_landing_l4_3_v1_b',
                                          'velocity_mps': 2.0,
                                          'waypoints_enu_m': [[7068.705, 6300.566, 0.0], [7075.988, 6310.696, 0.0]]},
                               'type': 'move_entity'},
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_safe_touchdown',
                                          'entity_id': 'uav_forced_landing_l4_3_v1',
                                          'velocity_mps': 1.0,
                                          'waypoints_enu_m': [[7066.559, 6299.352, 3], [7067.559, 6300.352, 0.8]]},
                               'type': 'move_entity'},
                              {'params': {'action_id': 'clear_landing_crowd', 'group_id': 'crowd_l4_3_v1'},
                               'type': 'clear_crowd'}],
