# L4-3_v1: physically animated semantic chain with a clear key event and continuous interaction

- **Layer**: L4
- **Contract**: U/V/P/F/L = 3/2/8/2/4
- **Inspect**: I10, long-lived U_inspect, moving inspect-view substitute, not static hover
- **Weather**: clear

## Chain
forced descent > crowd response

## Actors
Entities: semantic UAVs, background vehicles/pedestrians where present, and scenario-specific facilities/logical actors.
- Background vehicle semantics: hold/blocked by landing zone
- Background pedestrian semantics: evade/retreat crowd
