# L4-11_v1: physically animated semantic chain with a clear key event and continuous interaction
...
## Chain
AV fault > safe stop > report

## Actors
Entities: semantic UAVs, background vehicles/pedestrians where present, and scenario-specific facilities/logical actors.
- Background vehicle semantics: AV stop + follower reaction
- Background pedestrian semantics: roadside context
