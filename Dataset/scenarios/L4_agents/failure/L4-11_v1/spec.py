...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [145.0, 153.0, 75.0],
 ...
 'entities': [{'activation_tick': 0,
               ...
               'placement': {'edge_id': 'cg_edge_28', 'lane_index': 0, 'lateral_offset_m': 0.0, 'longitudinal_s': 47},
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [143.0, 159.0, 33], 'rotation_deg': {'yaw_deg': 70}},
               'placement_mode': 'world_pose',
               'route_waypoints_enu_m': []}],
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'vehicle.ground.boxcar.v1',
               'entity_id': 'av_fault_l4_11_v1',
               'initial_pos_enu': [147.0, 147.0, 0],
               'initial_rotation_deg': [0.0, 0.0, 82],
               'movement_waypoints': [],
               'visual_state': {'mode': 'autonomous'}},
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_av_report_l4_11_v1',
               'initial_pos_enu': [143.0, 159.0, 33],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_av_sensor_fault',
                 ...
                 {'actions': [{'params': {'action_id': 'move_av_safe_stop',
                  ...
                  'on_fire_emit': [],
                  'priority': 2,
                  'trigger': {'event_ref': 'av_sensor_fault', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'move_uav_blockage_report',
                                          'entity_id': 'uav_av_report_l4_11_v1',
                                          'velocity_mps': 5.0,
                                          'waypoints_enu_m': [[143.0, 159.0, 33], [163.0, 154.0, 25]]},
                               'type': 'move_entity'},
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'event_ref': 'av_safe_stop', 'type': 'event_fired'}},
                 {'actions': [{'params': {'action_id': 'set_av_hazard_lights',
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'event_ref': 'lane_blockage_report', 'type': 'event_fired'}}],
