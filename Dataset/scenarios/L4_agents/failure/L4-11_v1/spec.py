"""
Auto-generated P0 scenario spec for: L4-11_v1
Event type: L4-11 — Vehicle Breakdown Blocking Road
Category: failure
CAAC ref: Non-emergency (vehicle failure)
SORA SAIL: I
Severity: minor
"""
...
def build_spec():
    ...
    return ScenarioSpec(
        ...
        category="failure.l4-11",
        description="AV sensor failure, safe stop in lane",
        duration_ticks=900,
    )
