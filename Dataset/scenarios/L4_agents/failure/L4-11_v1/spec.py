...
SCENE_SETUP = {'$schema': 'scene_setup_v1',
 'cameras': [{'camera_id': 'demo_high_overview',
              'fov_deg': 90.0,
              'placement': {'position_enu_m': [7144.669, 6353.499, 75.0],
 ...
 'entities': [{'activation_tick': 0,
              ...
              {'activation_tick': 0,
               ...
               'placement': {'position_enu_m': [7143.0, 6359.0, 33],
                             'resolved_position_enu_m': [7143.0, 6359.0, 33],
...
SPEC_DATA = {'category': 'agents',
 ...
 'entities': [{'asset_id': 'vehicle.ground.boxcar.v1',
              ...
              {'asset_id': 'uav.inspect.quad.v1',
               'entity_id': 'uav_av_report_l4_11_v1',
               'initial_pos_enu': [7143.0, 6359.0, 33],
 ...
 'event_chain': [{'actions': [{'params': {'action_id': 'set_av_sensor_fault',
                 ...
                 {'actions': [{'params': {'action_id': 'move_uav_blockage_report',
                  ...
                  'on_fire_emit': [],
                  'priority': 3,
                  'trigger': {'delay_ticks': 30, 'event_ref': 'av_safe_stop', 'type': 'event_fired_after'}},
                 {'actions': [{'params': {'action_id': 'set_av_hazard_lights',
                  ...
                  'on_fire_emit': [],
                  'priority': 4,
                  'trigger': {'delay_ticks': 30, 'event_ref': 'lane_blockage_report', 'type': 'event_fired_after'}}],
